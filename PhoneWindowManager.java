...
/// M: BMW.
import com.freeme.hardware.fingerprint.FreemeFingerprintHelper;
import com.mediatek.multiwindow.MultiWindowProxy;

//*/ freeme.Sean, 20160107. Freeme import.
import com.freeme.server.DroiGlobalActions;
import com.freeme.server.DroiMagicTrack;
import com.freeme.server.DroiScreenOnProximityLock;
import com.droi.feature.FeatureOption;
//*/

//*/ freeme.zhiwei.zhang, 20160909. SmartWake.
import com.freeme.server.FreemeSmartWake;
//*/

//*/ freeme.zhiwei.zhang, 20160818. NavigationBar Show/Hide.
import com.freeme.server.policy.FreemeNavigationBarPolicy;
//*/

//*/ freeme.chenming, 20161119. Add Freeme Magnifier
import com.freeme.server.policy.FreemeMagnifier;
//*/

//*/ freeme wanbao.zhang,2017.0729,Use float window manager.
import com.android.security.control.SC_FloatWindowManager;
import com.android.security.control.SC_HomeCheckManager;
//*/

//*/ freeme:fanwuyang on: 2017/07/26 for super headset
...
public class PhoneWindowManager implements WindowManagerPolicy {
    ...
    //*/ freeme.luyangjie,20170616 for super headset
    long preLastHeadsethookDownTime = 0, preLastHeadsethookUpTime = 0, lastHeadsethookDownTime = 0, lastHeadsethookUpTime = 0;
    ...
    class SettingsObserver extends ContentObserver {
        ...
        void observe() {
            ...
            //*/ freeme.yuanchengye, 20140815. ThreeFingerSnap.
            resolver.registerContentObserver(Settings.System.getUriFor(
                    Settings.System.FREEME_THREE_POINTER_TAKE_SCREEN_SHOT), false, this,
                    UserHandle.USER_ALL);
            resolver.registerContentObserver(Settings.System.getUriFor(
                    Settings.System.FREEME_THREE_POINTER_START_HOTNOT), false, this,
                    UserHandle.USER_ALL);
            //*/
            updateSettings();
        }
    ...
    private void interceptPowerKeyDown(KeyEvent event, boolean interactive) {
        ...
        if (interactive && !mScreenshotChordPowerKeyTriggered
            ...
            //*/ freeme.Jack, 20150202. ScreenRecord.
    ...
    private void interceptScreenshotChord() {
        if (mScreenshotChordEnabled
            ...
            if (now <= mScreenshotChordVolumeDownKeyTime + SCREENSHOT_CHORD_DEBOUNCE_DELAY_MILLIS
                ...
                cancelPendingPowerKeyAction();
                //*/ freeme.lipengfei, 20160121. Disable screen-shotshortcut in OOBE.
                if (!isInOOBE()) return;
                //*/
    ...
    private final Runnable mScreenshotRunnable = new Runnable() {
        @Override
        public void run() {
            //*/ freeme.Linguanrong, 20150615. SuperShot.
            boolean supershot = Settings.System.getInt(mContext.getContentResolver(), 
                    Settings.System.SUPERSHOT_MODE_DEFAULT, 0) == 1;
            //*/ freeme,chenming. 20160707, Add log for THREE_POINTER_TAKE_SCREEN problem
            Log.d(TAG, "mScreenshotRunnable start take screenshot" + supershot);
            //*/
    ...
    void showGlobalActionsInternal() {
        sendCloseSystemWindows(SYSTEM_DIALOG_REASON_GLOBAL_ACTIONS);
        //*/ freeme.Sean, 20160113. Global actions.
        if (DroiGlobalActions.USE_DROI_GLOBAL_ACTIONS) {
            if (mDroiGlobalActions == null) {
                mDroiGlobalActions = new DroiGlobalActions(mContext, mWindowManagerFuncs);
            }
        } else
        //*/
        ...
        //*/ freeme.Sean, 20160113. Global actions.
        if (DroiGlobalActions.USE_DROI_GLOBAL_ACTIONS)
            mDroiGlobalActions.showDialog(keyguardShowing, isDeviceProvisioned());
        else
        //*/
    ...
    private void handleDoubleTapOnHome() {
        if (mDoubleTapOnHomeBehavior == DOUBLE_TAP_HOME_RECENT_SYSTEM_UI) {
            mHomeConsumed = true;
            //*/ freeme.luyangjie,20170614 for double home implement lock screen
            if(SystemProperties.get("ro.freeme.xiaolajiao_version").equals("1")){
                if(Settings.System.getInt(mContext.getContentResolver(), Settings.System.FREEME_DOUBLE_HOMEKEY_LOCK_SCREEN,0)==1){
    ...
    public void init(Context context, IWindowManager windowManager,
        ...
        //*/ freeme.wangalei, 20160227. FloatTask.
        ipoEventFilter.addAction(GAMEMODE_INTENT);
        //*/
        ...
        //*/ freeme.Sean, 20150107. MagicTrack.
        mDroiMagicTrack = new DroiMagicTrack(mContext, mWindowManagerFuncs);
        //*/
        //*/ freeme.Sean, 20150107. TouchProtect.
        if (FeatureOption.FREEME_TOUCH_PROTECT) {
            mDroiScreenOnProximityLock = new DroiScreenOnProximityLock(mContext);
        }
        //*/

        //*/ freeme.zhiwei.zhang, 20160909. SmartWake.
        mFreemeSmartWake = new FreemeSmartWake(mContext, this, mBroadcastWakeLock, mHandler, MSG_DISPATCH_MEDIA_KEY_WITH_WAKE_LOCK);
        //*/

        //*/ freeme.yuanchengye, 20140815, ThreeFinger gesture.
        IntentFilter threePointerFilter = new IntentFilter();
        threePointerFilter.addAction(FREEME_THREE_POINTER_START_HOTNOT_ACTION);
        threePointerFilter.addAction(FREEME_THREE_POINTER_TAKE_SCREEN_SHOT_ACTION);
        context.registerReceiver(mFreemeThreePointerReceiver, threePointerFilter);
        //*/

        //*/ freeme.chenming, 20161119. Add Freeme Magnifier
        if (FeatureOption.FREEME_MAGNIFIER_SUPPORT) {
            new FreemeMagnifier(context);
        }
        //*/
    }
    ...
    public void updateSettings() {
        ...
        synchronized (mLock) {
            ...
            //*/ freeme.yuanchengye, 20140815. ThreeFinger gesture.
            mThreePointerSwipeDownEnable = Settings.System.getIntForUser(resolver,
                    Settings.System.FREEME_THREE_POINTER_TAKE_SCREEN_SHOT, 1, UserHandle.USER_CURRENT) == 1;
            mThreePointerSwipeUpEnable = Settings.System.getIntForUser(resolver,
                    Settings.System.FREEME_THREE_POINTER_START_HOTNOT, 1, UserHandle.USER_CURRENT) == 1;
            try {
                mWindowManager.setSwipeActionUseThreeFingersMode(mThreePointerSwipeDownEnable || mThreePointerSwipeUpEnable);
            } catch (RemoteException ex) {
    ...
    public int checkAddPermission(WindowManager.LayoutParams attrs, int[] outAppOp) {
        ...
        //*/ freeme wanbao.zhang,2017.0729,Use float window manager.
        if(outAppOp[0] != AppOpsManager.OP_NONE && !SC_FloatWindowManager.getInstance().isToastType(attrs) && SC_FloatWindowManager.getInstance().isBlockApp(attrs.packageName)) {
            return SC_FloatWindowManager.FLOAT_WINDOW_NOT_ALLOWED;
        }
        //*/
    ...
    public void adjustWindowParamsLw(WindowManager.LayoutParams attrs) {
        ...
        /*/ freeme.Jack, 20160421. GMO effects, enable transparent statusbar.
        if (ActivityManager.isHighEndGfx()
        /*/
        if (true
        //*/
    ...
    public int windowTypeToLayerLw(int type) {
        ...
        case TYPE_TOP_MOST:
            return 31;
        //*/ freeme.biantao, 20170913. Rounded corner mask.
        case    WindowManager.LayoutParams.TYPE_ROUNDED_CORNER_MASK:
            return 40;
        //*/
        }
    ...
    public int getNonDecorDisplayWidth(int fullWidth, int fullHeight, int rotation) {
        if (mHasNavigationBar) {
            ...
            if (mNavigationBarCanMove && fullWidth > fullHeight) {
                //*/ freeme.zhiwei.zhang, 20160818. NavigationBar Show/Hide.
                if (FeatureOption.FREEME_NAVIGATIONBAR_MIN && isNaviBarMini()) {
                    return fullWidth;
                }
                //*/
            ...
            if (mNavigationBarOnBottom) {
                if (transit == TRANSIT_EXIT
                    ...
                    if (FeatureOption.FREEME_NAVIGATIONBAR_MIN) {
                        return R.anim.freeme_dock_bottom_exit;
                    }
                    //*/
                ...
                if (transit == TRANSIT_EXIT
                    ...
                    // Do not show hide animation while opening features.
                    if (FeatureOption.FREEME_NAVIGATIONBAR_MIN) {
                        return R.anim.freeme_dock_right_exit;
                    }
                    //*/
    ...
    public long interceptKeyBeforeDispatching(WindowState win, KeyEvent event, int policyFlags) {
        ...
        if (keyCode == KeyEvent.KEYCODE_HOME) {
	        //*/ freeme.wangalei, 20160227. FloatTask.
            if(mIsGameMode) return -1;
            //*/
            //*/ freeme.biantao, 20160519. Dispatch the home key to the application.
            if (win != null && win.getAttrs() != null) {
                final int flagEx = win.getAttrs().flagsEx;
                if ((flagEx & WindowManager.LayoutParams.FLAG_EX_HOMEKEY_DISPATCHED) != 0) {
            ...
            if (!down) {
                ...
                if (telecomManager != null && telecomManager.isRinging()) {
                    ...
                    /*/freeme.gejun, 20160701 enable home when fullscreen income
                    return -1;
                    /*/
                    if(Settings.Global.getInt(mContext.getContentResolver(),
                            Settings.System.FREEME_INCALL_ACTIVITY, 0) != 1){
                        Log.i(TAG, "Float Incall Enable HOME key!");
                    } else {
                        return -1;
                    }
                    //*/
            ...
            if (repeatCount == 0) {
                ...
                if (mHomeDoubleTapPending) {
                    ...
                    //*/ freeme.zhangshaopiao,20171106 for remove double home implement lock screen
                ...
                if (!keyguardOn) {
                    //*/freeme.luyangjie,20170803.BV303J delete Long Press Home KeyEvent
            ...
            //*/ freeme.zhiwei.zhang, 20161018. NavigationBar Show/Hide - RecentKey.
                ...
                if (mLongPressOnHomeBehavior != LONG_PRESS_HOME_RECENT_SYSTEM_UI) {
                    performHapticFeedbackLw(null, HapticFeedbackConstants.LONG_PRESS, false);
                    sendEvent(KeyEvent.KEYCODE_RECENT, KeyEvent.ACTION_DOWN, 0, SystemClock.uptimeMillis());
                    sendEvent(KeyEvent.KEYCODE_RECENT, KeyEvent.ACTION_UP, 0, SystemClock.uptimeMillis());
                } else {
                    if (!keyguardOn()) {
            ...
            //*/
        //*/ freeme.Linguanrong, 20140322. FloatTask.
        } else if (keyCode == KeyEvent.KEYCODE_BACK) {
            if (down && (event.getFlags() & KeyEvent.FLAG_LONG_PRESS) != 0) {
                ContentResolver res = mContext.getContentResolver();
	
                // freeme.Liuchao, 20140819. Nothing to do on.
                boolean superPowerMode = Settings.System.getInt(res,
                            Settings.System.FREEME_SUPPER_POWER_SAVE_ENABLE, 0) == 1;
                if (superPowerMode){
                    return -1;
                }
                
                boolean quick_show_floattask = Settings.System.getInt(res,
                            Settings.System.FREEME_QUICK_SHOW_FLOATTASK, 0) != 0;
                
                if(!quick_show_floattask) {
                    return -1;
                }
                
                String FLOATTASK_VALUE = Settings.System.FREEME_SHOW_FLOATTASK;
                Intent service = new Intent("com.freeme.floattask.IFloatTaskService");
                service.setPackage("com.freeme.floattask");

                boolean FloatTaskEnable = Settings.System.getInt(res, FLOATTASK_VALUE, 0) != 0;                
                if (FloatTaskEnable) {
                    mContext.stopService(service);
                } else {
                ...
                Settings.System.putInt(res, FLOATTASK_VALUE, FloatTaskEnable ? 0 : 1);
                return -1;
            }
        //*/
        ...
        //*/ freeme.zhiwei.zhang, 20161018. NavigationBar Show/Hide - RecentKey.
        else if (keyCode == KeyEvent.KEYCODE_RECENT) {
            // +++ freeme.biantao, 20161020. Dispatch the recent key to the application.
            if (win != null && win.getAttrs() != null) {
                final int flagEx = win.getAttrs().flagsEx;
                if ((flagEx & WindowManager.LayoutParams.FLAG_EX_RECENTKEY_DISPATCHED) != 0) {
                    // the window wants to handle the recent key, so dispatch it to it.
                    return 0;
                }
            }
            // ---
            ...
            if (!down) {
                if (!mRecentkeyLongPressed) {
                    toggleRecentApps();
                } else {
                    mRecentkeyLongPressed = false;
                }
            } else if ((event.getFlags() & KeyEvent.FLAG_LONG_PRESS) != 0) {
    ...
    private void launchAssistAction(String hint, int deviceId) {
        //*/ freeme.zhiwei.zhang, 20161018. NavigationBar Show/Hide - RecentKey.
        boolean startFreemeAssistant = true;
        try {
            ...
            startFreemeAssistant = false;
        }
        if (startFreemeAssistant) {
            return;
        }
        //*/
    ...
    public void beginLayoutLw(boolean isDefaultDisplay, int displayWidth, int displayHeight,
        ...
        if (isDefaultDisplay) {
            ...
            //*/ freeme.zhiwei.zhang, 20160818. NavigationBar Show/Hide.
            if (FeatureOption.FREEME_NAVIGATIONBAR_MIN && navVisible) {
                navVisible = navVisible && canShowNavigationBar();
            } else if (navVisible) { // fix. while the feature is not open, and screen on proximity lock need fullscreen.
                navVisible = navVisible && filterforFreemeScreenOnProximityLock();
            }
            //*/
                ...
                if (mNavigationBarOnBottom) {
                    ...
                    if (transientNavBarShowing) {
                        ...
                        if (!mIsAlarmBoot && !mIsShutDown) {
                            ...
                            //*/ freeme.zhiwei.zhang, 20160818. NavigationBar Show/Hide.
                            // If NaviBar is Mini, dock bottom is down actually,
                            // but we can not modify mTmpNavigationFrame.top.
                            if (FeatureOption.FREEME_NAVIGATIONBAR_MIN && isNaviBarMini()) {
                    ...
                    // But now, stable frame is affected by whether NaviBar is Mini.
                    if (FeatureOption.FREEME_NAVIGATIONBAR_MIN && isNaviBarMini()) {
                        mStableRight = mStableFullscreenRight = displayWidth - overscanRight;
                    }
                    //*/
                    if (transientNavBarShowing) {
                        mNavigationBarController.setBarShowingLw(true);
                        ...
                        if (!mIsAlarmBoot && !mIsShutDown) {
                            ...
                            //*/ freeme.zhiwei.zhang, 20160818. NavigationBar Show/Hide.
                            // If NaviBar is Mini, dock right is to edge actually, 
                            // but we can not modify mTmpNavigationFrame.top.
                            if (FeatureOption.FREEME_NAVIGATIONBAR_MIN && isNaviBarMini()) {
            ...
            if (mStatusBar != null) {
                ...
                //*/ freeme.zhiwei.zhang, 20160818. NavigationBar Show/Hide.
                // expand status bar height.
                if (FeatureOption.FREEME_NAVIGATIONBAR_MIN && isKeyguardShowingAndNotOccluded()) {
                    vf.bottom = mSystemBottom;
                }
                //*/
            ...
            if ((fl & (FLAG_LAYOUT_IN_SCREEN | FLAG_LAYOUT_INSET_DECOR))
                ...
                if (attrs.type == TYPE_STATUS_BAR_PANEL
                    ...
                    if (DEBUG_LAYOUT) Slog.v(TAG, String.format(
                                ...
                                //*/ freeme.biantao, 20170913. Rounded corner mask.
                                || attrs.type == WindowManager.LayoutParams.TYPE_ROUNDED_CORNER_MASK
                                //*/
            ...
            ServiceConnection conn = new ServiceConnection() {
                ...
                public void onServiceConnected(ComponentName name, IBinder service) {
                    synchronized (mScreenshotLock) {
                        ...
                        if (mStatusBar != null && mStatusBar.isVisibleLw())
                            msg.arg1 = 1;
                        //*/ freeme.zhiwei.zhang, 20160920. NavigationBar Show/Hide.
                        if (FeatureOption.FREEME_NAVIGATIONBAR_MIN) {
                            if (!isNaviBarMini()) {
                                msg.arg2 = 1;
                            }
    ...
    public int interceptKeyBeforeQueueing(KeyEvent event, int policyFlags) {
        ...
        switch (keyCode) {
            ...
            case KeyEvent.KEYCODE_HEADSETHOOK: {
                ...
                if (!list.isEmpty() && list.get(0) != null
                    ...
                    if (!className.equals("com.sprd.validationtools.itemstest.HeadSetTest")
                        && !className.equals("com.android.incallui.InCallActivity")) {
                        if (down) {
                            ...
                            } else if ((thisHeadsethookUpTime - thisHeadsethookDownTime) >= 1000) {
                                sendHeadsetBroadcast(4);
                            }
                        }
                        result = 0;
                        result &= ~ACTION_PASS_TO_USER;
            ...
            //*/ freeme.biantao, 20160728. Freeme fingerprint require;
            case KeyEvent.KEYCODE_F10: {
                if (FeatureOption.FREEME_FINGERPRINT_CUSTOM_SUPPORT) {
                    if (down) {
                        FreemeFingerprintHelper.interceptFingerprintKeyDown(mContext);
                    }
                }
                break;
            }
            ...
            //*/ droi.xushuai,20161207. add fp signle/double/long press for fingerprint
        ...
        if (mFreemeSmartWake != null) {
            int smartwakeResult = mFreemeSmartWake.interceptKeyBeforeQueueing(event, policyFlags, mAwake);
            if ((smartwakeResult & FREEME_ACTION_WAKEUP_SCREEN) != 0) {// need wake up screen.
                isWakeKey = true;
            }
            if ((smartwakeResult & FREEME_ACTION_CLEAR_PASS_TO_USER) != 0) {// need clear ACTION_PASS_TO_USER.
                result &= ~ACTION_PASS_TO_USER;
            }
        }
        //*/

        //*/ freeme.Sean, 20160316.TouchProtect.
        if (FeatureOption.FREEME_TOUCH_PROTECT) {
            mDroiScreenOnProximityLock.interceptKeyBeforeQueueing(event, policyFlags, interactive);
        }
        //*/
    ...
    public void startedWakingUp() {
        ...
        //*/ freeme.azmohan, 20171213. faceprint.
        if (mKeyguardSecure && !mKeyguardOccluded) {
            mContext.startService(new Intent()
                    .setComponent(new ComponentName("com.freeme.face.simple",
                            "com.freeme.face.simple.FaceprintService"))
                    .putExtra("command", 102));
        }
        //*/
        if (mKeyguardDelegate != null) {
    ...
    public void screenTurnedOff() {
        ...
        //*/ freeme.Sean, 20160316. TouchProtect.
        if (FeatureOption.FREEME_TOUCH_PROTECT) {
            mDroiScreenOnProximityLock.releaseScreenOnProximitySensor();
        }
        //*/
    }
    ...
    public void screenTurningOn(final ScreenOnListener screenOnListener) {
        ...
        //*/ freeme.Sean, 20160316. TouchProtect.
        if (FeatureOption.FREEME_TOUCH_PROTECT) {
            if (mSystemReady && isDeviceProvisioned()){
                mDroiScreenOnProximityLock.aquire();
            }
        }
        //*/
    }
    ...
    public void systemReady() {
        ...
        synchronized (mLock) {
            updateOrientationListenerLp();
            mSystemReady = true;
            //*/ freeme.Sean, 20160114. MagicTrack.
            if (mDroiMagicTrack != null){
                mDroiMagicTrack.systemReady(mSystemReady);
            }
            //*/
            //*/ freeme.Sean, 20160114. TouchProtect.
            if (FeatureOption.FREEME_TOUCH_PROTECT) {
                mDroiScreenOnProximityLock.systemReady(mSystemReady);
            }
            //*/
            mHandler.post(new Runnable() {
                @Override
                public void run() {
                    updateSettings();
                    //*/ freeme.biantao, 20170913. Rounded corner mask.
                    com.android.internal.widget.RoundedCornerView.Wrapper
                            .getInstance(mContext)
                            .updateSettings(mSystemReady);
                    //*/
                }
            });
        ...
        //*/ freeme.zhiwei.zhang, 20160818. NavigationBar Show/Hide.
        if (FeatureOption.FREEME_NAVIGATIONBAR_MIN) {
            mNavigationBarPolicy = new FreemeNavigationBarPolicy(mContext, mWindowManagerFuncs);
                    ...
                    new WindowManagerPolicy.PointerEventListener() {
                        public void onPointerEvent(MotionEvent motionEvent) {
                            if (mNavigationBarPolicy != null) {
                                mNavigationBarPolicy.updatePolicyState(mDisplay,
                                        mNavigationBarOnBottom, isKeyguardShowingAndNotOccluded());
    ...
    Intent createHomeDockIntent() {
        //*/ freeme wanbao.zhang,2017.07.29,Used to count desktop startup times.
        SC_HomeCheckManager.getInstance().homeStartCount(mContext);
        //*/
    ...
    BroadcastReceiver mIpoEventReceiver = new BroadcastReceiver() {
        public void onReceive(Context context, Intent intent) {
            ...
            if (action.equals(IPO_ENABLE)) {
                ...
                ipoSystemBooted();
            //*/ freeme.wangalei, 20160227. FloatTask.
            } else if(action.equals(GAMEMODE_INTENT)){
                mIsGameMode = intent.getBooleanExtra("gamemode",false);   
            //*/
            } else {
   ...
   ///@}
    ...
    private void ipoSystemBooted() {
        ...
        //*/ freeme.Sean, 20160316. TouchProtect.
        if (FeatureOption.FREEME_TOUCH_PROTECT) {
            mDroiScreenOnProximityLock.setVolumeUpKeyTriggered(false);
        }
        //*/
    ...
    //*/ freeme.wangalei, 20160227. FloatTask.
    public static final String GAMEMODE_INTENT = "com.freeme.action.gamemode";
    public static boolean mIsGameMode = false;
    //*/

    //*/ freeme.zhiwei.zhang, 20160909. SmartWake.
    private FreemeSmartWake mFreemeSmartWake;
    public static final int FREEME_ACTION_CLEAR_PASS_TO_USER = 0x00000001;
    public static final int FREEME_ACTION_WAKEUP_SCREEN = 0x00000010;
    //*/

    //*/ freeme.zhiwei.zhang, 20160818. NavigationBar Show/Hide.
    private FreemeNavigationBarPolicy mNavigationBarPolicy;
    private boolean filterforFreemeScreenOnProximityLock() {
        WindowManager.LayoutParams attr = mFocusedWindow != null ? mFocusedWindow.getAttrs() : null;
        int windowType = attr != null ? attr.type : 0;
        if (mStatusBar != mFocusedWindow && windowType == TYPE_KEYGUARD_DIALOG && keyguardOn()) {// above keyguard, full screen.
            return false;
        }
        return true;
    }
    ...
    private boolean canShowNavigationBar() {
        WindowManager.LayoutParams attr = mFocusedWindow != null ? mFocusedWindow.getAttrs() : null;
        int windowType = attr != null ? attr.type : 0;
        boolean drawSystemBar = attr != null &&
                (attr.privateFlags & WindowManager.LayoutParams.PRIVATE_FLAG_HIDE_NAVI_BAR) != 0;

        boolean result = false;
        // do not change the seq.
        if (mStatusBar == mFocusedWindow) {
            result = !isKeyguardShowingAndNotOccluded(); // keyguard is covered.
        } else if (windowType == TYPE_KEYGUARD_DIALOG && keyguardOn()) {// above keyguard, full screen.
            result = false;
        } else if (windowType == TYPE_DREAM) { // just above keyguard, but show nav bar.
            result = true;
        } else if ((windowType != TYPE_KEYGUARD && !drawSystemBar)) {
            result = true;
        }
        return result;
    }
    ...
    //*/ freeme.zhiwei.zhang, 20161018. NavigationBar Show/Hide - RecentKey.
    private boolean mRecentkeyLongPressed;
    ...
    //*/Added by tyd Sean 20150107 for: handle min screen mode
    private DroiGlobalActions mDroiGlobalActions;
    private DroiMagicTrack mDroiMagicTrack;
    //*/
    //*/ freeme.Sean, 20160614. TouchProtect.
    private DroiScreenOnProximityLock mDroiScreenOnProximityLock;
    //*/
    ...
    private void interceptScreenRecordChord() {
        if (mScreenshotChordEnabled
            ...
            if (now <= mScreenshotChordVolumeDownKeyTime + SCREENSHOT_CHORD_DEBOUNCE_DELAY_MILLIS
                ...
                cancelPendingPowerKeyAction();
                //*/Add by droi lipengfei 20160121 for disable shortcut in OOBE
                if(!isInOOBE()) return;
                //*/
    ...
    //*/ freeme.yuanchengye, 20140815. ThreeFinger gesture.
    public final static String FREEME_THREE_POINTER_START_HOTNOT_ACTION = "freeme.intent.action.THREE_POINTER_START_HOTNOT";
    public final static String FREEME_THREE_POINTER_TAKE_SCREEN_SHOT_ACTION = "freeme.intent.action.THREE_POINTER_TAKE_SCREEN_SHOT";

    private boolean mThreePointerSwipeDownEnable;
    private boolean mThreePointerSwipeUpEnable;
    ...
    private BroadcastReceiver mFreemeThreePointerReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            //*/
            if (action.equals(FREEME_THREE_POINTER_TAKE_SCREEN_SHOT_ACTION) && mThreePointerSwipeDownEnable) {
                // freeme.lipengfei, 20160121. Disable SuperShot in OOBE.
                if (!isInOOBE()) return;

                mHandler.post(mScreenshotRunnable);
            } else if (action.equals(FREEME_THREE_POINTER_START_HOTNOT_ACTION) && mThreePointerSwipeUpEnable){
                try {
                    Intent hotnotIntent = new Intent();
                    hotnotIntent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                    hotnotIntent.setClassName("com.freemetech.hotknot","com.freemetech.hotknot.activity.MainActivity");
                    mContext.startActivity(hotnotIntent);
                } catch (Exception e) {
                    e.printStackTrace();
                }
            }
    ...
    private boolean isInOOBE() {
        return 1 == Settings.System.getInt(mContext.getContentResolver(), Settings.System.FREEME_OOBE_STATE_FINISH , 1);
    }
    //*/
	...
	//*/ droi.xushuai,20161207. add fp signle/double/long press for fingerprint
	private boolean isFPLongPress = false;
	private int fpTouchUpCounts = 0;
	private	long firstTouchTime = 0;
	private void setFingerprintPressStatus(int status) {
	    switch (status) {
	        case 1: {//reset press status
	            fpTouchUpCounts = 0;
	            firstTouchTime = 0;
	            break;
	        }
	        case 2: {//continue count
	            fpTouchUpCounts = 1;
	            firstTouchTime = SystemClock.uptimeMillis();
	            break;
	        }
	        default:
	            break;
    ...
    private void sendHeadsetBroadcast(int clickCount) {
        Boolean isSuperHeadset = Settings.System.getInt(mContext.getContentResolver(), Settings.System.FREEME_SUPER_HEADSET_CONTROL, 0) == 1;
        switch (clickCount) {
            case 4:
                String clickName4 = Settings.System.getString(mContext.getContentResolver(), Settings.System.FREEME_LONG_CLICK_FUNCTION_SETTINGS);
                if (isSuperHeadset) {
                    if(Settings.System.getInt(mContext.getContentResolver(), Settings.System.FREEME_LONG_CLICK_FUNCTION, 0) == 1){
                        //*/ freeme:fanwuyang on: 2017/08/15 add fuction for jingdong super headset
                        if (!(android.text.TextUtils.isEmpty(clickName4) || clickName4.equals("null"))) {
                            String[] actionItem = clickName4.split(";");
                            startAPP(actionItem[2]);
                        }
                        /*/
                        if(SystemProperties.get("ro.freeme.xlj_jingdong").equals("1")){
                            previousMusic();
                ...
                //*/ freeme:fanwuyang on: 2017/09/22 add fuction for super headset to music
                } else {
                    previousMusic();
                }
                /*/
                ...
                break;
            case 3:
                String clickName3 = Settings.System.getString(mContext.getContentResolver(), Settings.System.FREEME_THREE_CLICK_FUNCTION_SETTINGS);
                if (isSuperHeadset) {
                    if(Settings.System.getInt(mContext.getContentResolver(), Settings.System.FREEME_THREE_CLICK_FUNCTION, 0) == 1){
                        //*/ freeme:fanwuyang on: 2017/08/15 add fuction for jingdong super headset
                        if (!(android.text.TextUtils.isEmpty(clickName3) || clickName3.equals("null"))) {
                            String[] actionItem = clickName3.split(";");
                            startAPP(actionItem[2]);
                        }
                        /*/
                        if(SystemProperties.get("ro.freeme.xlj_jingdong").equals("1")){
                ...
                break;
            case 2:
                String clickName2 = Settings.System.getString(mContext.getContentResolver(), Settings.System.FREEME_DOUBLE_CLICK_FUNCTION_SETTINGS);
                if (isSuperHeadset) {
                    if(Settings.System.getInt(mContext.getContentResolver(), Settings.System.FREEME_DOUBLE_CLICK_FUNCTION, 0) == 1){
                        //*/ freeme:fanwuyang on: 2017/08/15 add fuction for jingdong super headset
                        if (!(android.text.TextUtils.isEmpty(clickName2) || clickName2.equals("null"))) {
                            String[] actionItem = clickName2.split(";");
                            startAPP(actionItem[2]);
                        }
                        /*/
                        if(SystemProperties.get("ro.freeme.xlj_jingdong").equals("1")){
                ...
                break;
            case 1:
                String clickName = Settings.System.getString(mContext.getContentResolver(), Settings.System.FREEME_CLICK_FUNCTION_SETTINGS);
                if (isSuperHeadset) {
                    if(Settings.System.getInt(mContext.getContentResolver(), Settings.System.FREEME_CLICK_FUNCTION, 0) == 1){
                        //*/ freeme:fanwuyang on: 2017/08/15 add fuction for jingdong super headset
                        if (!(android.text.TextUtils.isEmpty(clickName) || clickName.equals("null"))) {
                            String[] actionItem = clickName.split(";");
                            startAPP(actionItem[2]);
                        }
                        /*/
                        if(SystemProperties.get("ro.freeme.xlj_jingdong").equals("1")){
    ...
    public void startAPP(String appPackageName) {
        try {
            ...
            Toast.makeText(mContext, "Not install this APP", Toast.LENGTH_LONG).show();
        }
    }
    ...
    private void nextMusic() {
        ...
        nextIntent.setAction("com.android.music.musicservicecommand.next");
    ...
    private void previousMusic() {
        ...
        previousIntent.setAction("com.android.music.musicservicecommand.previous");
        previousIntent.putExtra("command", "previous");
        mContext.sendBroadcast(previousIntent);
    }

    private void continuMusic() {
        Intent continuIntent = new Intent();
        continuIntent.setAction("com.android.music.musicservicecommand.togglepause");
        continuIntent.putExtra("command", "togglepause");
        mContext.sendBroadcast(continuIntent);
    }
    //*/
}
