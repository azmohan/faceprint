...
DCORE_TEST_MODE1 = no
# FREEME, frameworks/base/packages/SettingsProvider/res/values/freeme_defaults.xml
#DEFAULT_INPUT_METHOD = com.sohu.inputmethod.sogou/.SogouIM
...
OPEN_MAIN_FAKE_FLASHLIGHT = no
SGM37891_MAIN_FLASHLIGHT = no

## Freeme Begin ################################################################

#CREATE_PROJECT_INFO=20160506141829

# @{ Freeme Common #############################################################

FREEME_LABEL=FreemeOS
FREEME_VERNO=6.2
FREEME_CHANNEL_NO=TYD001
FREEME_CUSTOMER_NO=DROI
FREEME_CUSTOMER_BRANCH=1
FREEME_CUSTOM_PRODUCTION=1

#FREEME_PRODUCT_MANUFACTURER = Droi
#FREEME_PRODUCT_DEVICE = Freeme
...
# -- FactoryMode
FREEME_FACTORYMODE_SUPPORT=yes
# BCamera [no|yes|yes_yes]
FREEME_FACTORYMODE_BCAMERA=yes
FREEME_FACTORYMODE_FCAMERA=yes
FREEME_FACTORYMODE_MSENSOR=no
FREEME_FACTORYMODE_GSENSOR=yes
FREEME_FACTORYMODE_LSENSOR=yes
FREEME_FACTORYMODE_DSENSOR=yes
FREEME_FACTORYMODE_HSENSOR=no
FREEME_FACTORYMODE_WIFI=yes
FREEME_FACTORYMODE_GYROSCOPE=no
FREEME_FACTORYMODE_MHL=no
FREEME_FACTORYMODE_LED=no
FREEME_FACTORYMODE_GPS=yes
FREEME_FACTORYMODE_ATLIGHT=no
FREEME_FACTORYMODE_HIFI=no
FREEME_FACTORYMODE_DUALMIC=no
FREEME_FACTORYMODE_INFRARED=no
FREEME_FACTORYMODE_AUDIO_DUALSPEAKER=no
FREEME_FACTORYMODE_STROBE_BACK=yes
FREEME_FACTORYMODE_STROBE_FRONT=no
# [home]
FREEME_FACTORYMODE_KEYBOARD_EXT=

# Instrument
FREEME_FACTORYMODE_INSTRUMENT=no

# -- OTA
FREEME_OTA_SUPPORT=yes
FREEME_OTA_LANGUAGE=zh
FREEME_OTA_FLASH=freeme6

# -- Fingerprint
FREEME_FINGERPRINT_SUPPORT=
FREEME_FINGERPRINT_FRONT=no
FREEME_FINGERPRINT_CUSTOMIZED=yes
# [success:[1|0], fail:[2|0]]
FREEME_FINGERPRINT_UNLOCK_VIBRATES=3
FREEME_FINGERPRINT_TEST_PASSWORD=no

# -- Application/Feature Misc
FREEME_FONT=yes
FREEME_ICON=no
FREEME_TP_GLOVE_SUPPORT=no
FREEME_NON_TOUCH_OPERATION_SUPPORT=yes
FREEME_VISITOR_MODE_SUPPORT=no
FREEME_SAHRED_SUPPORT=no
FREEME_TOUCH_PROTECT=yes
# [application packages]
FREEME_PACKAGE_OVERRIDES=

# [package-name]
FREEME_DEFAULT_LAUNCHER = com.freeme.freemelite.odm
# [package-name]
FREEME_DEFAULT_LOCKSCREEN = com.freeme.lockscreen.halo
# [fzlantinghei.ttf]
FREEME_DEFAULT_FONT=
# [0.92]
FREEME_DEFAULT_FONT_SCALE=

# -- SystemUi & Keyguard
FREEME_NAVIGATIONBAR_MIN=yes
...
FREEME_SMART_LEATHERCASE_MODE_SUPPORT=no
FREEME_LOCKSCREEN_SUPPORT=yes
FREEME_SUSPENSION_SUPPORT=no

# -- System Misc
FREEME_EXTREME_LK_SUPPORT=yes
FREEME_EXTREME_LK_TRIM=yes
FREEME_EXTREME_LK_DISPLAY_TASKS=5
FREEME_USER_WITH_DEXPREOPT=yes
FREEME_USER_WITH_USB_DEBUGGABLE=no
FREEME_EXTERNAL_FONTS=yes
# Auto generate wifi mac address
FREEME_AUTO_MAC_SUPPORT=yes
FREEME_NIGHTMARE_SUPPORT=no
FREEME_POWERGURU_SUPPORT=no
# Wallpaper filter-out, refs to ThemeClubCore
FREEME_WALLPAPER_FILTER_OUT=
# Boot audio[no|yes|yes_no]
...
# Vibrator Tuner
FREEME_VIBRATOR_TUNER_SUPPORT=yes
# Product for factory(ProjectFactoryConfig for more)
FREEME_PRODUCT_FOR_FACTORY=
# Freeme Magnifier
FREEME_MAGNIFIER_SUPPORT=no
# System config audible
FREEME_CONFIG_AUDIBLE_NOTIFICATION = Proxima.ogg
FREEME_CONFIG_AUDIBLE_ALARM = Alarm_Lights.ogg
FREEME_CONFIG_AUDIBLE_RINGTONE = happy.ogg
FREEME_CONFIG_AUDIBLE_MESSAGE = sms-received3.ogg
# Flash Size
FREEME_FLASH_SIZE=16

# Volte
FREEME_VOLTE_ENABLED=yes

# @} ###########################################################################


# @{ freeme wanbao.zhang & swang, 20160604. For FreemeSE. ######################
FREEME_PERMISSION_CONTROL_SUPPORT=yes
FREEME_SECURITY_HI_SUPPORT=yes
FREEME_SECURITY_CENTER_APK=yes
FREEME_SECURITY_STATIC_UNINSTALL=yes
FREEME_SECURITY_NETWORK_PERMMISION=yes
FREEME_SECURITY_NOTIFI_MANAGER=yes
FREEME_SECURITY_BPM_MANAGER=yes
FREEME_SECURITY_SHUTDOWN_CLEAN_PROCESS=yes
FREEME_SECURITY_NUMBER_MARKS=yes
FREEME_SECURITY_PERMISSION_PREMIUM=yes
FREEME_SECURITY_AUTO_CLEAN_TASK=yes
FREEME_SECURITY_PINGERPRINT=no
FREEME_SECURITY_ASSOCIATION_START=yes

#-- SecurityService
FREEME_SECURITY_GET_APPLIST=yes
FREEME_SECURITY_GET_WIFILIST=yes
FREEME_SECURITY_DEFAULT_APP=yes
FREEME_SECURITY_INSTALL_APP=yes
FREEME_SECURITY_RECEIVER_MANAGER=yes
FREEME_SECURITY_FLOAT_MANAGER=yes
FREEME_SECURITY_TMS=no
FREEME_SECURITY_TMS_FS=no
FREEME_SECURITY_TMS_TASK=no
FREEME_SECURITY_TMS_DISABLE=no
FREEME_SECURITY_HIDE_APP=yes
FREEME_SECURITY_DATACOLLECT_SUPPORT=no
FREEME_SECURITY_INSTALL_WARNING_NOFREEMEOS=no
FREEME_SECURITY_TROI=yes
# @} ###########################################################################


# @{ freeme.xiaocui, 20160531. For FreemeAP. ###################################
FREEME_DESKCLOCK_SUPPORT=yes
FREEME_POWEROFF_ALARM =yes
FREEME_WEATHER_SUPPORT=no
FREEME_WEATHER_WIDGET_SUPPORT=yes
FREEME_HEALTHCENTER_SUPPORT=no
FREEME_CALCULATOR_SUPPORT=yes
FREEME_FLOATTASK_SUPPORT=no
FREEME_COMPASS_SUPPORT=no
FREEME_CALENDAR_SUPPORT=no
FREEME_CRONTAB_SUPPORT=yes
FREEME_MULTISIM_RINGTONE_SUPPORT = yes
FREEME_LEGALNOTICES_SUPPORT = yes
# @} ###########################################################################


# @{ freeme.Greg, 20160601. For FreemeLite. ####################################
FREEME_FASHION_LAUNCHER_SUPPORT = no
FREEME_PRIVATE_WIDGET_NEWS_PAGE_SUPPORT = no
FREEME_THEME_CLUB_SUPPORT = no
FREEME_BIGLAUNCHER_APP = no
FREEME_SUPPER_POWER_SAVE_SUPPORT = no
FREEME_FESTIVALWALLPAPER_APP = yes
FREEME_LOCK_NOW_APP= yes
FREEME_THEMES_RESOURCES = no
FREEME_THEME_JUSTYOUNG = no
FREEME_THEME_FORWOMAN = no
FREEME_THEME_XUJI = no
FREEME_THEME_ZHUJUE = no
FREEME_THEME_XINJING = no
FREEME_THEME_EURO2016 = no
FREEME_SHAKE_OPEN_APP_SUPPORT=no
FREEME_DESKTOP_EMOTIBOT_XIAOYING_SUITE = no
# @} ###########################################################################


# @{ freeme.John, 20160603. For FreemeSS. ######################################
FREEME_LUCKY_MONEY_APP = no
FREEME_OOBE_APP=yes
FREEME_PUBLIC_INFO=yes
FREEME_DEFAULT_WRITE_STORAGE_SUPPORT = no
FREEME_SMART_SMS_SUPPORT = yes
FREEME_FULLSCREEN_INCOMING_SUPPORT=yes
FREEME_CALLLOG_NUMBERS_LIMIT=no
FREEME_HOLIDAY_MODE_SUPPORT=no
FREEME_SMART_DIAL_SUPPORT=yes
FREEME_DVFS_HOTPLUG_PERFORMANCE=no
FREEME_YELLOWPAPE_SUPPORT=yes
FREEME_CHANNELINFO_APP=yes
FREEME_VOIP_CALL_SUPPORT=no
FREEME_WIFI_ENHANCEMENT=yes
FREEME_DUAL_SERIAL=no
FREEME_REVERSE_DIAL_SILENT_SUPPORT = yes
## Fake System
FREEME_FAKE_ROM_RAM=no
FREEME_FAKE_PRODUCT_MODEL=no
FREEME_BOOT_ANIMATION_ALTER=no
FREEME_XIAOLAJIAO_VERSION=no
FREEME_DISABLE_SECURITY_ICON=no
FREEME_XIAOLAJIAO_JINGDONG=no
FREEME_YIZHIFU_SUPPORT = no
FREEME_HULEBANG_SUPPORT = no
FREEME_XIAOLAJIAO_BV303G = no
# @} ###########################################################################


# @{ freeme.KimiWu, 20160602. For FreemeMM. ####################################
FREEME_MM_CAMERA=yes
FREEME_MM_CAMERA_CHILDMODE=yes
FREEME_MM_CAMERA_LARGEMODE=yes
FREEME_MM_CAMERA_POSEMODE=yes
FREEME_MM_CAMERA_WATERMARKMODE=yes
FREEME_MM_GALLERY_SUPPORT=yes
FREEME_MM_MUSIC_APP=yes
FREEME_MM_FILE_MANAGER_APP=yes
FREEME_MM_VIDEO_APP=no
FREEME_MM_VOICE_ASSISTANT=yes
FREEME_MM_FMRADIO_APP=yes
FREEME_MM_SOUNDRECORDER_SUPPORT=yes
FREEME_MM_SUPERSHOT_SUPPORT=yes
FREEME_MM_DESKTOP_CAMERA=no
FREEME_MM_DESKTOP_MUSIC=no
# @} ###########################################################################
...
# ---- Internal Apps
FREEME_SERVICE_APP=no
FREEME_OPERATION_MANUAL=no
FREEME_USERBOOK_APP=no
FREEME_MULTIPLEACCOUNTS_APP=no

# @} ###########################################################################


# @{ freeme.xuqian, 20170826 no support fastboot ####################################
MTK_FASTBOOT_SUPPORT = no
# @} ###########################################################################

## Freeme End ##################################################################
FREEME_SECURITY_HOME_CHECK=yes

# @{ freeme.fanwuyang,2017/10/17 for telecom project to change cpuFrep to 1.25
FREEME_XIAOLAJIAO_TELECOM=no
# @}
# @{ freeme. luyangjie,2017.10.25, for Project BV303A
FREEME_XIAOLAJIAO_BV303A=no
# @}

FREEME_PACKAGE_FreemeFaceServiceSimple = yes
