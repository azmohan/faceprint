...
public final class FreemeSeekBarDialogPreference extends DialogPreference
    ...
    private final int mMinValue = 0; // default value 0
    private final int mStepValue = 1; // default step 1
    ...
    public FreemeSeekBarDialogPreference(final Context context, final AttributeSet attrs) {
        super(context, attrs);

        TypedArray a = context.obtainStyledAttributes(
                attrs,new int[] { android.R.attr.max }, 0, 0);
        mMaxValue = a.getInteger(0, 0);
        a.recycle();
    ...
    protected void onPrepareDialogBuilder(final AlertDialog.Builder builder) {
        builder.setPositiveButton(android.R.string.ok, this)
            ...
            .setNeutralButton(R.string.vib_Reset, this);
    }
