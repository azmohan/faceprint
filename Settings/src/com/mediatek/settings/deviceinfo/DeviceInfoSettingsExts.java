...
public class DeviceInfoSettingsExts {
    ...
    //*/ freeme:fanwuyang on: 2017/11/30 modify setting baseband version
    private static final String KEY_BASEBAND_VERSION_3 = "baseband_version_3";
    //*/ 
    ...
    public void initMTKCustomization(PreferenceGroup parentPreference) {
        ...
        //*/ freeme:fanwuyang on: 2017/12/01 modify bv3b3 build number & device model name
        if (SystemProperties.get("ro.freeme.xlj_bv3b3").equals("1") || SystemProperties.get("ro.freeme.xlj_bv303z").equals("1") || SystemProperties.get("ro.freeme.xlj_bv3a3a").equals("1") || SystemProperties.get("ro.freeme.xlj_bv3a3h").equals("1") || SystemProperties.get("ro.freeme.xlj_bv3a3g").equals("1")) {
            mExt.updateSummary(findPreference(KEY_DEVICE_MODEL), Build.MODEL, "20170608S");
            mExt.updateSummary(findPreference(KEY_BUILD_NUMBER), Build.DISPLAY, "20170608S_V1.0");
        } else {
    ...
    private void updateTitleToActivityLabel(String key) {
       ...
       if (intent != null) {
            ...
            //*/Added by tyd liuchao remove preference if no activity can performe the given intent
            if(listSize == 0){
    ...
    private void initBasebandVersion() {
        ...
        //*/ freeme:fanwuyang on: 2017/11/30 modify setting baseband version
        if (SystemProperties.get("ro.freeme.xlj_bv3b3").equals("1")) {
                String n1 = "FM_BASE_15C_W16.51.1_P3.09|sc983x_modem|08-11-2017 22:34:29"; 
                String n2 = "MARLIN_BA_Release_W16.39.4_Debug09-29-201623:30:48|MARLIN|BA|";
                String baseband3 = n1 + "\n" + n2;
                removePreference(findPreference(KEY_BASEBAND_VERSION));
                removePreference(findPreference(KEY_BASEBAND_VERSION_2));
                findPreference(KEY_BASEBAND_VERSION_3).setSummary(baseband3);
                updateBasebandTitle();
        }
	//*/freeme.zhangjunxiang , 20171205 for modify baseband version
	else if(SystemProperties.get("ro.freeme.xlj_bv303z").equals("1") || SystemProperties.get("ro.freeme.xlj_bv3a3a").equals("1") || SystemProperties.get("ro.freeme.xlj_bv3a3h").equals("1") || SystemProperties.get("ro.freeme.xlj_bv3a3g").equals("1")){
		String n1 = "FM_BASE_15C_W16.51.1_P3.08.02|sc983x_modem|09-01-2017 20:24:18"; 
		String n2 = "MARLIN_BA_Release_W16.39.4_Deb";
		String n3 = "ug09-29-201623:30:48|MARLIN|BA|";
		String baseband3 = n1 + "\n" + n2 + "\n" + n3;
	...
	//*/
	    ...
	    removePreference(findPreference(KEY_BASEBAND_VERSION_3));
    ...
    private void updateBasebandTitle() {
        ...
        //*/ freeme:fanwuyang on: 2017/11/30 modify setting baseband version
        if (findPreference(KEY_BASEBAND_VERSION_3) != null) {
            findPreference(KEY_BASEBAND_VERSION_3).setTitle(slot3);
        }
        //*/ 
    }
