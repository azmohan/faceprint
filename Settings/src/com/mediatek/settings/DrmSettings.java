...
public class DrmSettings extends SettingsPreferenceFragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if(mService.isExistData(R.string.privacy_settings, R.string.drm_settings_title)){
            mService.update(R.string.privacy_settings, R.string.drm_settings_title);
        }else{
            mService.insert(R.string.privacy_settings, R.string.drm_settings_title, this.getClass().getName(), 1, "");
        }
        //*/
    }
