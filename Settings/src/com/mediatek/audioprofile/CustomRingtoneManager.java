...
/**
 * CustomRingtoneManager provides access to ringtones, notification, and other types
 ...
 * {@link #ACTION_CUSTOM_RINGTONE_PICKER} intent to launch the picker as a subactivity.
 * 
 * @see Ringtone
 */
public class CustomRingtoneManager {

    private static final String TAG = "CustomRingtoneManager";
    ...
    /**
     * Type that refers to sounds that are used for messages.
     */
    ...
    public static final String ACTION_CUSTOM_RINGTONE_PICKER = "android.intent.action.CUSTOM_RINGTONE_PICKER";

    /**
     * Given to the ringtone picker as a boolean. Whether to show an item for
     * "Default".
     * 
     * @see #ACTION_CUSTOM_RINGTONE_PICKER
     */
     ...
     * {@link System#DEFAULT_VIDEO_CALL_URI} to have the "Default" item
     * checked.
     * 
     * @see #ACTION_CUSTOM_RINGTONE_PICKER
     */
     ...
     * {@link System#DEFAULT_NOTIFICATION_URI}, or
     * {@link System#DEFAULT_ALARM_ALERT_URI}, or
     * {@link System#DEFAULT_VIDEO_CALL_URI} to have the "Default" point to
     ...
     * {@link System#DEFAULT_NOTIFICATION_URI}, or
     * {@link System#DEFAULT_ALARM_ALERT_URI}, or
     * {@link System#DEFAULT_VIDEO_CALL_URI} if the default was chosen,
    ...
    /**
     * Constructs a CustomRingtoneManager. This constructor is recommended as its
     * constructed instance manages cursor(s).
     * 
     * @param activity The activity used to get a managed cursor.
     */
    public CustomRingtoneManager(Activity activity) {
        mContext = mActivity = activity;
        setType(mType);
    }

    /**
     * Constructs a CustomRingtoneManager. The instance constructed by this
    ...
    /**
     * Gets which type(s) of ringtones will be listed by this.
     * 
     * @return type The type(s), one or more of {@link #TYPE_RINGTONE},
     *            {@link #TYPE_NOTIFICATION}, {@link #TYPE_ALARM},
     *            {@link #TYPE_ALL}.
     * @see #EXTRA_RINGTONE_TYPE           
     */
     ...
     * <p>
     * If {@link CustomRingtoneManager#CustomRingtoneManager(Activity)} was not used, the
    ...
    public Cursor getCursor() {
        ...
        return mCursor = new SortCursor(new Cursor[] { mediaCursor },
    ...
    public Ringtone getRingtone(int position , Uri ringtoneUri) {
    /*/
    ...
    //*/
        ...
        if(ringtoneUri != null)
        {
        	mPreviousRingtone = getRingtone(mContext, ringtoneUri, inferStreamType());
        }
        else
        {
    ...
    /**
     * Gets the position of a {@link Uri} within this {@link CustomRingtoneManager}.
     * 
    ...
    public static Uri getValidRingtoneUri(Context context) {
        final CustomRingtoneManager rm = new CustomRingtoneManager(context);
        
        Uri uri = getValidRingtoneUriFromCursorAndClose(context, rm.getMediaRingtones());
    ...
    private static Ringtone getRingtone(final Context context, Uri ringtoneUri, int streamType) {
        ...
        try {
            ...
            //*/ xiaocui for jb veron;
            r.setUri(ringtoneUri);
            /*/
            r.open(ringtoneUri, true);
            //*/
     ...
     *            {@link #TYPE_ALARM}, or {@link #TYPE_VIDEO_CALL}, or
     *            {@link #TYPE_MESSAGE}.
     ...
     *            {@link System#DEFAULT_NOTIFICATION_URI}, or
     *            {@link System#DEFAULT_ALARM_ALERT_URI}, or
     *            {@link System#DEFAULT_VIDEO_CALL_URI}, or
     *            {@link System#DEFAULT_MESSAGE_URI}.
    ...
    public static int getDefaultType(Uri defaultRingtoneUri) {
        if (defaultRingtoneUri == null) {
            ...
            return TYPE_VIDEO_CALL;
        } else if (defaultRingtoneUri.equals(Settings.System.DEFAULT_MESSAGE_URI)) {
            return TYPE_MESSAGE;
        } else {
            return -1;
        }
    ...
    public static Uri getDefaultUri(int type) {
        if ((type & TYPE_RINGTONE) != 0) {
            ...
            return Settings.System.DEFAULT_MESSAGE_URI;
        } else {
            return null;
        }
    }
