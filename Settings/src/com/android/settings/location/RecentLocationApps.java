...
//*/Adds by Jiangshouting 2015.12.28 for setting code transplant
...
public class RecentLocationApps {
    ...
    //*/Add by tyd jiangshouting 2015.0908 for click backButton 
    //in AppDetailsActivity can return LocationSetting Fragment.
    ...
    private class PackageEntryClickedListener
        ...
        public boolean onPreferenceClick(Preference preference) {
            ...
            //*/Motify by tyd jiangshouting 2015.0908 for click backButton 
            //in AppDetailsActivity can return LocationSetting Fragment.
            if(frg != null){
                ...
                mActivity.startPreferencePanel(InstalledAppDetails.class.getName(), args,
                        R.string.application_info_label, null, frg , 0);
            }
            return true;
            //*/
        }
    ...
    //*/ Add by tyd jiangshouting 2015.0908 for click backButton 
    //in AppDetailsActivity can return LocationSetting Fragment.
    public void setReturnFragment(Fragment frg){
        this.frg = frg;
    }
    //*/
