...
public class LocationMode extends LocationSettingsBase
    ...
    private PreferenceScreen createPreferenceHierarchy() {
        ...
        if(mService.isExistData(R.string.location_settings_title, R.string.location_mode_title)){
            mService.update(R.string.location_settings_title, R.string.location_mode_title);
        }else{
            mService.insert(R.string.location_settings_title, R.string.location_mode_title,  LocationMode.class.getName(), 1, "");
        }
        //*/
