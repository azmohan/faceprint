...
public class DateTimeSettings extends SettingsPreferenceFragment
    ...
    //*/ Added by Tyd Linguanrong for koobee style guide, 2014-7-25
    private ListPreference mDateFormat;
    //private PreferenceCategory mLanSettingCategory;
    private PreferenceCategory mDateTimeCategory;    
    //private Preference mLanguageSetting;
    //*/
    ...
    private void initUI() {
        ...
        //*/ Added by Tyd Linguanrong for koobee style guide, 2014-7-25
        // mLanSettingCategory = (PreferenceCategory) findPreference("language_settings_category");
        mDateTimeCategory = (PreferenceCategory) findPreference("datetime_settings_category");
        //mLanguageSetting = findPreference("language_settings");
        if (this.getActivity().getIntent().getBooleanExtra("extra_is_oobe", false)) {
            //getPreferenceScreen().removePreference(mLanSettingCategory);
            getPreferenceScreen().removePreference(mDateTimeCategory);
            //getPreferenceScreen().removePreference(mLanguageSetting);
        }
        //*/
