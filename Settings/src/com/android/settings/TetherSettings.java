...
public class TetherSettings extends SettingsPreferenceFragment
    ...
    public void onCreate(Bundle icicle) {
        ...
        if(mService.isExistData(R.string.radio_control_sim_title, R.string.tether_settings_title_all)){
            mService.update(R.string.radio_control_sim_title, R.string.tether_settings_title_all);
        }else{
            mService.insert(R.string.radio_control_sim_title, R.string.tether_settings_title_all, this.getClass().getName(), 1, "");
        }
        //*/
    }
