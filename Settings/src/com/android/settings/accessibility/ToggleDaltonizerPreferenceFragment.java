...
public class ToggleDaltonizerPreferenceFragment extends ToggleFeaturePreferenceFragment
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if(mService.isExistData(R.string.accessibility_settings, R.string.accessibility_display_daltonizer_preference_title)){
            mService.update(R.string.accessibility_settings, R.string.accessibility_display_daltonizer_preference_title);
        }else{
            mService.insert(R.string.accessibility_settings, R.string.accessibility_display_daltonizer_preference_title, "com.android.settings.accessibility.ToggleDaltonizerPreferenceFragment", 1,"");
        }
        //*/
    }
