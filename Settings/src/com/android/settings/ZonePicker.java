...
public class ZonePicker extends ListFragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        if(mService.isExistData(R.string.date_and_time_settings_title, R.string.date_time_set_timezone)){
            mService.update(R.string.date_and_time_settings_title, R.string.date_time_set_timezone);
        }else{
            mService.insert(R.string.date_and_time_settings_title, R.string.date_time_set_timezone, this.getClass().getName(), 1, "");
        }
        //*/
        return view;
    }
