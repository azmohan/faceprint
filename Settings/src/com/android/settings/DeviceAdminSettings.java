...
public class DeviceAdminSettings extends ListFragment {
    ...
    public void onCreate(Bundle icicle) {
        ...
        if(mService.isExistData(R.string.security_settings_title, R.string.manage_device_admin)){
            mService.update(R.string.security_settings_title, R.string.manage_device_admin);
        }else{
            mService.insert(R.string.security_settings_title, R.string.manage_device_admin, this.getClass().getName(), 1, "");
        }
        //*/
    }
