...
import com.freeme.hardware.fingerprint.FreemeFingerprintManager;
...
public class ChooseLockGeneric extends SettingsActivity {
    ...
    public static class ChooseLockGenericFragment extends SettingsPreferenceFragment {
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            if(mService.isExistData(R.string.lock_pwd_title, R.string.unlock_set_unlock_launch_picker_title)){
                mService.update(R.string.lock_pwd_title, R.string.unlock_set_unlock_launch_picker_title);
            }else{
                mService.insert(R.string.lock_pwd_title, R.string.unlock_set_unlock_launch_picker_title, this.getClass().getName(), 1, "");
            }
            //*/
        ...
        void updateUnlockMethodAndFinish(int quality, boolean disabled) {
            ...
            if (quality >= DevicePolicyManager.PASSWORD_QUALITY_NUMERIC) {
				...
				//*/ freeme.biantao, 20171219. Faceprint.
                com.freeme.settings.face.FaceprintSettings.removeAllFaceprint(getContext());
                //*/
            ...
            /// M: Add for voice unlock entrance @ {
                ...
                //*/Added by tyd Greg 2014-05-29,for visitor mode
                ChooseLockSettingsHelper.writeVistorModePasswordStateNone(getActivity());
                //*/
        ...
        private void removeAllFingerprintTemplatesAndFinish() {
            if (mFingerprintManager != null && mFingerprintManager.isHardwareDetected()
                ...
                /*/ freeme.biantao, 20160722. Remove all fingerprints by wrapper fingerprint manager since fucking IC hal implements.
                mFingerprintManager.remove(new Fingerprint(null, 0, 0, 0), mRemovalCallback);
                /*/
                new FreemeFingerprintManager(mFingerprintManager).remove(new Fingerprint(null, 0, 0, 0), mRemovalCallback);
                //*/
            } else {
                finish();
            }
