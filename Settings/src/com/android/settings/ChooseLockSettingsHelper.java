...
public final class ChooseLockSettingsHelper {
    ...
    //*/Added by tyd Greg 2014-05-29,for visitor mode
    public static void writeVistorModePasswordStateNone(Context context) {
        Settings.System.putString(context.getContentResolver(), "tydtech_vistor_mode_password_state", 
                "tydtech_vistor_mode_password_state_none");
        int state = Settings.System.getInt(context.getContentResolver(), "tydtech_vistor_mode_state", 0);
        if (state == 1) {
            Intent intent = new Intent("com.tydtech.ACTION_VISITOR_MODE_OFF");
            intent.putExtra("state" , true);
            context.sendBroadcast(intent);
            Settings.System.putInt(context.getContentResolver(), "tydtech_vistor_mode_state", 0);
        }
    }
    //*/
}
