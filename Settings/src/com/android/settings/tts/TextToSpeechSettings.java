...
public class TextToSpeechSettings extends SettingsPreferenceFragment implements
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if(mService.isExistData(R.string.language_settings, R.string.tts_settings_title)){
            mService.update(R.string.language_settings, R.string.tts_settings_title);
        }else{
            mService.insert(R.string.language_settings, R.string.tts_settings_title, this.getClass().getName(), 1, "");
        }
        //*/
    }
