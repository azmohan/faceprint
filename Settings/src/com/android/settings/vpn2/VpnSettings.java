...
public class VpnSettings extends SettingsPreferenceFragment implements
    ...
    public void onCreate(Bundle savedState) {
        ...
        if(mService.isExistData(R.string.radio_control_sim_title, R.string.vpn_settings_title)){
            mService.update(R.string.radio_control_sim_title, R.string.vpn_settings_title);
        }else{
            mService.insert(R.string.radio_control_sim_title, R.string.vpn_settings_title, this.getClass().getName(), 1, "");
        }
        //*/
    }
