...
public class DevelopmentSettings extends SettingsPreferenceFragment
    ...
    //*/Add by chenruoquan 2015-11-06
    public static final String PREF_FILE_MORE = "developmentmore";
    //*/
    ...
    public static final String PREF_SHOW_MORE = "showmore";
    //*/
    ...
    //*/ Modified by tyd Jack 20121220 for, disable app aee/anr dialog    
    private static final String SHOW_AEE_DIALOG_KEY = "show_aee_dialog";
    private static final String SHOW_ANR_DIALOG_KEY = "show_anr_dialog";

    private static final String SHOW_AEE_PROPERTY = "persist.sys.ams.aee_dialog";
    private static final String SHOW_ANR_PROPERTY = "persist.sys.ams.anr_dialog";
    //*/

    //*/ Modified by tyd Jack 20150518 for, Extreme Low memory killer
    private static final String ENABLE_EXTREME_LK_KEY = "enable_extreme_lk";

    private static final String ENABLE_EXTREME_LK_PROPERTY = "persist.sys.ams.extreme_lk";
    //*/
    ...
    //*/ Modified by tyd Jack 20121220 for, disable app aee/anr dialog 
    private SwitchPreference mShowAeeDialog;
    private SwitchPreference mShowAnrDialog;
    //*/
    
    //*/ Modified by tyd Jack 20150518 for, Extreme Low memory killer
    private SwitchPreference mEnableExtremeLK;
    //*/
    ...
    //*/Add by tyd chenruoquan 2015-11-06 for show simple development
    ...
    public void onCreate(Bundle icicle) {
        ...
        //*/Add by tyd chenruoquan 2015-11-06 for show simple development
        isShowMore = getActivity().getSharedPreferences(DevelopmentSettings.PREF_FILE_MORE,
                Context.MODE_PRIVATE).getBoolean(DevelopmentSettings.PREF_SHOW_MORE,
                        android.os.Build.TYPE.equals("eng"));
        //*/
        //*/freeme.xupeng, 20170613. show entire development items as default for XLJ
        ...
        //Modify by tyd chenruoquan 2015-11-06 for show simple development
        //addPreferencesFromResource(R.xml.development_prefs);
        if(isShowMore){
            addPreferencesFromResource(R.xml.development_prefs);
        }else{
            addPreferencesFromResource(R.xml.development_prefs_simple);
            ...
            mShowAeeDialog = (SwitchPreference) findPreference(SHOW_AEE_DIALOG_KEY);
            mShowAnrDialog = (SwitchPreference) findPreference(SHOW_ANR_DIALOG_KEY);
//            mAllPrefs.add(mShowAllANRs);
//            mResetSwitchPrefs.add(mShowAllANRs);
//            mAllPrefs.add(mShowAeeDialog);
//            mResetSwitchPrefs.add(mShowAeeDialog);
//            mAllPrefs.add(mShowAnrDialog);
//            mResetSwitchPrefs.add(mShowAnrDialog);
            
            
            boolean isChecked = (mAdbDialog != null && mAdbDialog.isShowing()) ? true :
                (Settings.Global.getInt(getActivity().getContentResolver(), Settings.Global.ADB_ENABLED, 0) != 0);
            updateSwitchPreference(mEnableAdb, isChecked);
            
            updateShowTouchesOptions();
            updatePointerLocationOptions();
            updateShowAllANRsOptions();
            updateShowAeeAnrDialog();
        ...
        //*/Added by tyd yuanchengye 20140507, for remove mBugreportInPower preferece
        ...
        //*/ Modified by tyd Jack 20121220 for, disable app aee/anr dialog 
        mShowAeeDialog = (SwitchPreference) findPreference(
                SHOW_AEE_DIALOG_KEY);
        mShowAnrDialog = (SwitchPreference) findPreference(
                SHOW_ANR_DIALOG_KEY);    
        ...
        //*/ Modified by tyd Jack 20150518 for, Extreme Low memory killer
        mEnableExtremeLK = (SwitchPreference) findPreference(
                ENABLE_EXTREME_LK_KEY); 
        
        if("1".equals(SystemProperties.get("ro.tyd_extreme_lk_support"))){
          mAllPrefs.add(mEnableExtremeLK);
          mResetSwitchPrefs.add(mEnableExtremeLK);
        } else {
          final PreferenceGroup debugApplicationsCategory = (PreferenceGroup)
                findPreference(DEBUG_APPLICATIONS_CATEGORY_KEY);
          debugApplicationsCategory.removePreference(mEnableExtremeLK);
        }
        //*/
    ...
    private void writeAnimationScaleOption(int which, ListPreference pref, Object newValue) {
        try {
            /*/ Modified by tyd Jack 20150709, for reset default animation scale 0.5f 
    ...
    //*/ Modified by tyd Jack 20150515 for, disable background anr
    ...
    //*/ Modified by tyd Jack 20121220 for, disable app aee/anr dialog 
    private void updateShowAeeAnrDialog() {
        updateSwitchPreference(mShowAeeDialog, SystemProperties.getBoolean(SHOW_AEE_PROPERTY, false));
        updateSwitchPreference(mShowAnrDialog, SystemProperties.getBoolean(SHOW_ANR_PROPERTY, false));
    }
    //*/
    
    //*/ Modified by tyd Jack 20150518 for, Extreme Low memory killer
    private void updateEnableExtremeLK() {
        updateSwitchPreference(mEnableExtremeLK, SystemProperties.getBoolean(ENABLE_EXTREME_LK_PROPERTY, true));
    }
    //*/
    ...
    public boolean onPreferenceTreeClick(PreferenceScreen preferenceScreen, Preference preference) {
        ...
        if (preference == mEnableAdb) {
            if (mEnableAdb.isChecked()) {
                ...
                //*/Modify by tyd chenruoquan 2015-11-07
                if(mVerifyAppsOverUsb!=null){
                    mVerifyAppsOverUsb.setEnabled(false);
        ...
        //*/ Modified by tyd Jack 20121220 for, disable app aee/anr dialog 
        } else if (preference == mShowAeeDialog) {
            SystemProperties.set(SHOW_AEE_PROPERTY, mShowAeeDialog.isChecked() ? "true" : "false");
            pokeSystemProperties();
        } else if (preference == mShowAnrDialog) {
            SystemProperties.set(SHOW_ANR_PROPERTY, mShowAnrDialog.isChecked() ? "true" : "false");
            pokeSystemProperties();
        //*/
        //*/ Modified by tyd Jack 20150518 for, Extreme Low memory killer
        } else if (preference == mEnableExtremeLK) {
            SystemProperties.set(ENABLE_EXTREME_LK_PROPERTY, mEnableExtremeLK.isChecked() ? "true" : "false");
            pokeSystemProperties();
        //*/
