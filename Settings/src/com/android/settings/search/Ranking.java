...
public final class Ranking {
    ...
    public static final int RANK_ACCESSIBILITYEXT = 23;
    public static final int RANK_LOCKINGPASSWORD = 24;
    public static final int RANK_SENSORSALIBRATION = 25;
    public static final int RANK_ACCOUNTSETTINGS = 26;
    public static final int RANK_STORAGEANDBATTERT = 27;
    //*/
    ...
    static {
        ...
        sRankMap.put(ChooseLockGeneric.ChooseLockGenericFragment.class.getName(), RANK_LOCKINGPASSWORD);
        sRankMap.put(ScreenPinningSettings.class.getName(), RANK_LOCKINGPASSWORD);
        //*/
        ...
        //*/Add by Tyd Jiangshouting 2015.11.19 for Setting search function lacking some data.
        //Accessibility Settings Ext
        sRankMap.put(AccessibilitySettingsExt.class.getName(), RANK_ACCESSIBILITYEXT);

        //Locking screen and password
        sRankMap.put(LockScreenAndPassword.class.getName(), RANK_LOCKINGPASSWORD);

        //SensorCalibration 
        sRankMap.put(SensorCalibrationFragment.class.getName(), RANK_SENSORSALIBRATION);

        //Account Settings 
        sRankMap.put(AccountSettings.class.getName(), RANK_ACCOUNTSETTINGS);

        //Storage and Battery 
        sRankMap.put(StorageAndBatterySettings.class.getName(), RANK_STORAGEANDBATTERT);
        //*/
