...
import com.android.settings.deviceinfo.StorageAndBatterySettings;
//*/
...
public final class SearchIndexableResources {
    ...
    static {
        ...
        sResMap.put(AccessibilitySettingsExt.class.getName(),
                new SearchIndexableResource(
                        Ranking.getRankForClassName(AccessibilitySettingsExt.class.getName()),
                        NO_DATA_RES_ID,
                        AccessibilitySettingsExt.class.getName(),
                        R.drawable.ic_settings_notifications));
        
        sResMap.put(LockScreenAndPassword.class.getName(),
                new SearchIndexableResource(
                        Ranking.getRankForClassName(LockScreenAndPassword.class.getName()),
                        NO_DATA_RES_ID,
                        LockScreenAndPassword.class.getName(),
                        R.drawable.ic_settings_notifications));

        sResMap.put(SensorCalibrationFragment.class.getName(),
                new SearchIndexableResource(
                        Ranking.getRankForClassName(SensorCalibrationFragment.class.getName()),
                        NO_DATA_RES_ID,
        ...
        sResMap.put(StorageAndBatterySettings.class.getName(),
                new SearchIndexableResource(
                        Ranking.getRankForClassName(StorageAndBatterySettings.class.getName()),
                        NO_DATA_RES_ID,
                        StorageAndBatterySettings.class.getName(),
                        R.drawable.ic_settings_notifications));
        //*/
		//*/ freeme.wanglei, 20171218. Faceprint.
        sResMap.put(FaceprintSettingsDashboard.class.getName(),
                new SearchIndexableResource(
                        Ranking.getRankForClassName(FaceprintSettingsDashboard.class.getName()),
                        NO_DATA_RES_ID,
                        FaceprintSettingsDashboard.class.getName(),
                        R.drawable.freeme_ic_faceprint));
        //*/
    }
