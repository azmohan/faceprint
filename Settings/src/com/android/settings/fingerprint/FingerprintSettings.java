    ...
    public static class FingerprintSettingsFragment extends SettingsPreferenceFragment
        ...
        protected void removeFingerprintPreference(int fingerprintId) {
            ...
            if (prefToRemove != null) {
                /*/ freeme.biantao, 20160727. Freeme fingerprint requires.
                if (!getPreferenceScreen().removePreference(prefToRemove)) {
                /*/
                if (!mCategoryFinger.removePreference(prefToRemove)) {
                //*/
        ...
        private PreferenceScreen createPreferenceHierarchy() {
            ...
            /*/
            mCategoryFinger = (PreferenceGroup) findPreference(CATEGORY_FINGER);
            if (mCategoryFinger != null) {
                if (!FeatureOption.FREEME_FINGERPRINT_CUSTOM_SUPPORT) {
                    root.removePreference(mCategoryFinger);
                    mCategoryFinger = root;
                }
            } else {
                mCategoryFinger = root;
            }
            addFingerprintItemPreferences(mCategoryFinger);
            mCategoryFuncs = (PreferenceGroup) findPreference(CATEGORY_FUNC);
            if (mCategoryFuncs != null) {
                if (FeatureOption.FREEME_FINGERPRINT_CUSTOM_SUPPORT) {
                    setFingerprintFuncItemPreferences(mCategoryFuncs);
                } else {
                    root.removePreference(mCategoryFuncs);
                }
            }
            //*/

            //*/ freeme.tangxiaohui, 20161124. for security softlock
            if (FeatureOption.FREEME_SECURITY_FINGERPRINT) {
                SwitchPreference slPreference = new SwitchPreference(root.getContext());
                slPreference.setKey(KEY_PREFERENCE_SOFTLOCK);
                slPreference.setTitle(R.string.soft_lock_control_enable);
                root.addPreference(slPreference);
                slPreference.setOnPreferenceChangeListener(this);
            }
            //*/
        ...
        public boolean onPreferenceChange(Preference preference, Object value) {
            ...
            if (KEY_FINGERPRINT_ENABLE_KEYGUARD_TOGGLE.equals(key)) {
                // TODO
            //*/ freeme.biantao, 20160727. Freeme fingerprint requires.
            } else if (KEY_PREFERENCE_FUNC_CAMERA.equals(key)) {
                boolean bvalue = ((Boolean) value).booleanValue();
                if (bvalue) {
                    showFuncGuideDialog(key);
                }
                Settings.System.putInt(getContentResolver(), Settings.System.FREEME_FP_CAPTURE_ENABLE, bvalue ? 1 : 0);
            } else if (KEY_PREFERENCE_FUNC_ALARM.equals(key)) {
                boolean bvalue = ((Boolean) value).booleanValue();
                if (bvalue) {
                    showFuncGuideDialog(key);
                }
                Settings.System.putInt(getContentResolver(), Settings.System.FREEME_FP_ALARM_CONTROL, bvalue ? 1 : 0);
            } else if (KEY_PREFERENCE_FUNC_DIAL.equals(key)) {
                boolean bvalue = ((Boolean) value).booleanValue();
                if (bvalue) {
                    showFuncGuideDialog(key);
                }
                Settings.System.putInt(getContentResolver(), Settings.System.FREEME_FP_DIAL_CONTROL, bvalue ? 1 : 0);
            } else if (KEY_PREFERENCE_FUNC_HOME.equals(key)) {
                boolean bvalue = ((Boolean) value).booleanValue();
                if (bvalue) {
                    showFuncGuideDialog(key);
                }
                Settings.System.putInt(getContentResolver(), Settings.System.FREEME_FP_HOME_CONTROL, bvalue ? 1 : 0);
            } else if (KEY_PREFERENCE_FUNC_VIDEO.equals(key)) {
                boolean bvalue = ((Boolean) value).booleanValue();
                if (bvalue) {
                    showFuncGuideDialog(key);
                }
                Settings.System.putInt(getContentResolver(), Settings.System.FREEME_FP_VIDEO_CONTROL, bvalue ? 1 : 0);
            } else if (KEY_PREFERENCE_FUNC_MUSIC.equals(key)) {
                boolean bvalue = ((Boolean) value).booleanValue();
                if (bvalue) {
                    showFuncGuideDialog(key);
                }
                Settings.System.putInt(getContentResolver(), Settings.System.FREEME_FP_MUSIC_CONTROL, bvalue ? 1 : 0);
            //*/

            //*/ freeme.tangxiaohui, 20160918. for security softlock
            } else if (KEY_PREFERENCE_SOFTLOCK.equals(key)) {
                boolean bvalue = ((Boolean) value).booleanValue();
                Settings.System.putInt(getContentResolver(), Settings.System.FREEME_FP_SOFTLOCK_CONTROL, bvalue ? 1 : 0);
            //*/
        ...
        public void onActivityResult(int requestCode, int resultCode, Intent data) {
            ...
            //*/ freeme.biantao, 20160725. Enhanced security of fingerprint managing.
            mWaitForLastActivityResult = false;
            //*/
        }

        //*/ freeme.biantao, 20160725. Enhanced security of fingerprint managing.
        private boolean mWaitForLastActivityResult;

        @Override
        public void onStop() {
            super.onStop();
            if ((mToken != null && mLaunchedConfirm)
                    && (!mWaitForLastActivityResult)
        ...
        //*/ freeme.biantao, 20160727. Freeme fingerprint requires.
        private static final String CATEGORY_FINGER = "fingerprint_category_finger";
        private PreferenceGroup mCategoryFinger;

        private static final String CATEGORY_FUNC = "fingerprint_category_func";
        private PreferenceGroup mCategoryFuncs;
        private static final String KEY_PREFERENCE_FUNC_CAMERA = "pref_func_camera";
        private static final String KEY_PREFERENCE_FUNC_ALARM = "pref_func_alarm";
        private static final String KEY_PREFERENCE_FUNC_DIAL = "pref_func_dial";
        private static final String KEY_PREFERENCE_FUNC_HOME = "pref_func_home";
        private static final String KEY_PREFERENCE_FUNC_VIDEO = "pref_func_video";
        private static final String KEY_PREFERENCE_FUNC_MUSIC = "pref_func_music";

        //*/ freeme.tangxiaohui, 20161124. for security softlock
        private static final String KEY_PREFERENCE_SOFTLOCK = "pref_fp_softlock";
        //*/

        private void setFingerprintFuncItemPreferences(PreferenceGroup root) {
            setPreferenceFunc(root, KEY_PREFERENCE_FUNC_CAMERA, Settings.System.FREEME_FP_CAPTURE_ENABLE, true);
            setPreferenceFunc(root, KEY_PREFERENCE_FUNC_ALARM, Settings.System.FREEME_FP_ALARM_CONTROL, true);
            setPreferenceFunc(root, KEY_PREFERENCE_FUNC_DIAL, Settings.System.FREEME_FP_DIAL_CONTROL, true);
            setPreferenceFunc(root, KEY_PREFERENCE_FUNC_HOME, Settings.System.FREEME_FP_HOME_CONTROL, true);
            setPreferenceFunc(root, KEY_PREFERENCE_FUNC_VIDEO, Settings.System.FREEME_FP_VIDEO_CONTROL, true);
            setPreferenceFunc(root, KEY_PREFERENCE_FUNC_MUSIC, Settings.System.FREEME_FP_MUSIC_CONTROL, true);
        }

        private void setPreferenceFunc(PreferenceGroup root, String prefkey, String settingKey, boolean visible) {
            SwitchPreference item = (SwitchPreference) root.findPreference(prefkey);
            if (item != null) {
                if (visible) {
                    item.setChecked(Settings.System.getInt(getContentResolver(), settingKey, 0) != 0);
                    item.setOnPreferenceChangeListener(this);
                } else {
                    root.removePreference(item);
                }
            }
        }

        private void showFuncGuideDialog(final String prefKey) {
            FuncGuideDialog funcGuideDialog = new FuncGuideDialog(getContext());
            Bundle args = new Bundle();
            args.putString("funcKey", prefKey);
            funcGuideDialog.setArguments(args);
            funcGuideDialog.setTargetFragment(this, 0);
            funcGuideDialog.show(getFragmentManager(), FuncGuideDialog.class.getName());
        }

        public static class FuncGuideDialog extends DialogFragment {

            private final Context mContext;

            public FuncGuideDialog(Context context) {
                mContext = context;
            }

            @Override
            public Dialog onCreateDialog(Bundle savedInstanceState) {
                final String funcKey = getArguments().getString("funcKey");

                View root = View.inflate(mContext, R.layout.freeme_fp_guide_dialog, null);
                ImageView contentImage = (ImageView) root.findViewById(R.id.guide_img);
                TextView contentTitle = (TextView) root.findViewById(R.id.guide_title);
                TextView contentDes = (TextView) root.findViewById(R.id.guide_des);
                switch (funcKey) {
                    case KEY_PREFERENCE_FUNC_CAMERA:
                        contentImage.setImageResource(R.drawable.freeme_fp_camera_capture);
                        contentTitle.setText(R.string.camera_capture_enable);
                        contentDes.setText(R.string.nv_camera_cpture_des);
                        break;
                    case KEY_PREFERENCE_FUNC_ALARM:
                        contentImage.setImageResource(R.drawable.freeme_fp_alarm_control);
                        contentTitle.setText(R.string.alarm_control_enable);
                        contentDes.setText(R.string.nv_alarm_control_des);
                        break;
                    case KEY_PREFERENCE_FUNC_DIAL:
                        contentImage.setImageResource(R.drawable.freeme_fp_dial_control);
                        contentTitle.setText(R.string.dial_enable);
                        contentDes.setText(R.string.nv_dial_control_des);
                        break;
                    case KEY_PREFERENCE_FUNC_HOME:
                        contentImage.setImageResource(R.drawable.freeme_fp_home_control);
                        contentTitle.setText(R.string.home_scroll_enable);
                        contentDes.setText(R.string.nv_home_control_des);
                        break;
                    case KEY_PREFERENCE_FUNC_VIDEO:
                        contentImage.setImageResource(R.drawable.freeme_fp_video_control);
                        contentTitle.setText(R.string.video_operate_enable);
                        contentDes.setText(R.string.nv_video_control_des);
                        break;
                    case KEY_PREFERENCE_FUNC_MUSIC:
                        contentImage.setImageResource(R.drawable.freeme_fp_music_control);
                        contentTitle.setText(R.string.music_operate_enable);
                        contentDes.setText(R.string.nv_music_control_des);
                        break;
                }

                final AlertDialog alertDialog = new AlertDialog.Builder(getActivity())
                        .setView(root)
                        .setPositiveButton(R.string.nv_get_it, null)
                        .create();
                return alertDialog;
            }
        }
        ...
        public void onDestroy() {
            super.onDestroy();
            /*/ freeme.biantao, 20160818. Enhanced security of fingerprint managing.
            // FIXME: Risky!!! Need testing.
    ...
    private static class LearnMoreSpan extends URLSpan {
        ...
        public static CharSequence linkify(CharSequence rawText, String uri) {
            ...
            for (Annotation annotation : spans) {
                ...
                /*/ freeme.biantao, 20160725. Remove spans since of non-gms caused exception.
