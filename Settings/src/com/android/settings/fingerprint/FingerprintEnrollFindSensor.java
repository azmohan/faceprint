...
public class FingerprintEnrollFindSensor extends FingerprintEnrollBase {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //*/ freeme.menglingqiang, 20161011. support finger print front.
        if (com.droi.feature.FeatureOption.FREEME_FINGERPRINT_FRONT) {
            TextView textView = (TextView) findViewById(R.id.security_settings_fingerprint_enroll_find_sensor_message);
            textView.setText(R.string.security_settings_fingerprint_enroll_find_sensor_message_front);

            ImageView imageView = (ImageView) findViewById(R.id.fingerprint_sensor_location);
            imageView.setImageResource(R.drawable.fingerprint_sensor_location_front);
        }
        //*/
