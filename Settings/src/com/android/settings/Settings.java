...
public class Settings extends SettingsActivity {
    ...
    */
    ...
    public static class EditProfileActivity extends SettingsActivity {/* empty */}
    //*/

    //*/freeme xiaocui, 20160526. SIM2 Ringtone
    public static class SelectSimSettings extends SettingsActivity { /* empty */ }
    //*/
    public static class AccessibilitySettingsExtActivity extends SettingsActivity { /* empty */ }
    public static class MasterClearActivity extends SettingsActivity { /* empty */ }
    //*/tyd gejun add for smart guide activity in dialer
    public static class IntelligentOperateSettingsActivity extends SettingsActivity { /* empty */ }
    //*/

    public static class LockScreenAndPasswordActivity extends SettingsActivity { /* empty */ }
