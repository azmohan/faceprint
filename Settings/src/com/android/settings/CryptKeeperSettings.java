...
public class CryptKeeperSettings extends InstrumentedFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedState) {
        ...
        if(mService.isExistData(R.string.lock_pwd_title, R.string.crypt_keeper_encrypt_title)){
            mService.update(R.string.lock_pwd_title, R.string.crypt_keeper_encrypt_title);
        }else{
            mService.insert(R.string.lock_pwd_title, R.string.crypt_keeper_encrypt_title, this.getClass().getName(), 1, "");
        }
        //*/
