...
public class SecuritySettings extends SettingsPreferenceFragment
    ...
    private static final String SWITCH_PREFERENCE_KEYS[] = {KEY_TOGGLE_INSTALL_APPLICATIONS };
    //*/
    ...
    //*/ freeme.xiaocui,20160711. delete encryption menu
    private static final String KEY_CRYPT_KEEPER_SETTINGS = "encryption";
    //*/
    ...
    private PreferenceScreen createPreferenceHierarchy() {
        ...
        /*/Remarked by tyd liuchao, 2015-07-09
        ...
        if (securityCategory != null) {
           securityCategory.removePreference(findPreference(KEY_CRYPT_KEEPER_SETTINGS));
        }
        //*/
        
        if (securityCategory != null) {
            maybeAddFingerprintPreference(securityCategory);
            //*/ freeme.biantao, 20171217. Faceprint.
            com.freeme.settings.face.FaceprintSettings.maybeAddFaceprintPreference(
                    securityCategory, UserHandle.myUserId());
            //*/
        ...
        mToggleAppInstallation = (SwitchPreference) findPreference(
                KEY_TOGGLE_INSTALL_APPLICATIONS);
        //*/Removed by tyd liuchao, 2015-08-18
        ...
        //*/Freeme, menglingqiang, 20160921, for visitor mode delete fingerprint Options
        if (FeatureOption.TYD_VISITOR_MODE_SUPPORT) {
            boolean isVistor = Settings.System.getInt(getContentResolver(), "tydtech_vistor_mode_state", 0) == 1;
            if(securityCategory != null && isVistor){
                root.removePreference(securityCategory);
            }
        }
        //*/
        //*/ freeme.wanglei, 20171217. Faceprint.
        if (securityCategory.findPreference(KEY_FINGERPRINT_SETTINGS) == null
                && securityCategory.findPreference(com.freeme.settings.face.FaceprintSettings.KEY_FACEPRINT_SETTINGS) == null) {
            getPreferenceScreen().removePreference(securityCategory);
        }
        //*/
        return root;
    }
    ...
    public boolean onPreferenceTreeClick(PreferenceScreen preferenceScreen, Preference preference) {
        ...
        if (KEY_CREDENTIALS_INSTALL.equals(key)){
            CustomHobbyService mService=new CustomHobbyService(getActivity());
            if(mService.isExistData(R.string.security_settings_title, R.string.credentials_install_nosdcard)){
                mService.update(R.string.security_settings_title, R.string.credentials_install_nosdcard);
            }else{
                mService.insert(R.string.security_settings_title, R.string.credentials_install_nosdcard,"android.credentials.INSTALL", 1, "activity");
            }
        }
        //*/
    ...
    private static class SecuritySearchIndexProvider extends BaseSearchIndexProvider {
        ...
        public List<String> getNonIndexableKeys(Context context) {
            ...
            if(keys.contains(KEY_OWNER_INFO_SETTINGS)){
                keys.remove(KEY_OWNER_INFO_SETTINGS);
            }
            if(keys.contains(KEY_UNLOCK_SET_OR_CHANGE)){
                keys.remove(KEY_UNLOCK_SET_OR_CHANGE);
            }
            //*/
    ...
    private void addPluginEntrance(PreferenceGroup deviceAdminCategory) {
        ...
        /*/  freeme.menglingqiang, 20161017. remove data protect option.
