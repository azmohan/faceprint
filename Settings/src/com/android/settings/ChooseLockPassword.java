...
public class ChooseLockPassword extends SettingsActivity {
    ...
    public static class ChooseLockPasswordFragment extends InstrumentedFragment
            ...
            if (mUiStage == Stage.Introduction) {
                ...
                if (mFirstPin.equals(pin)) {
                    ...
                    if (mHasChallenge) {
                        ...
                        //*/Modified by tyd lipengfei 20151026 for OOBE
                        //getActivity().setResult(RESULT_FINISHED);
                        boolean isFromOobe =
                                1 == android.provider.Settings.System.getInt(getActivity().getContentResolver(), android.provider.Settings.System.FREEME_OOBE_STATE_FINISH , 1);
                        if(isFromOobe){
                            getActivity().setResult(RESULT_FINISHED);
                        }else{
        ...
        private void finishConfirmStage(boolean wasSecureBefore) {
            ...
            boolean isFromOobe =
                            1 == android.provider.Settings.System.getInt(getActivity().getContentResolver(),
                            android.provider.Settings.System.FREEME_OOBE_STATE_FINISH , 1);
            getActivity().finish();
            mDone = true;
            //if (!wasSecureBefore) {
            if (!wasSecureBefore && isFromOobe) {
