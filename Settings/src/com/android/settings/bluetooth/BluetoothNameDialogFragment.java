...
//*/freeme.zhangshaopiao,20171106,add too long prompt
    ...
    public void afterTextChanged(Editable s) {
        if (mDeviceNameUpdated) {
            ...
            if (mOkButton != null) {
                ...
                //*/freeme.zhangshaopiao,20171106,add too long prompt
                if(Charset.forName("UTF-8").encode(s.toString()).limit() >= 50){
                    mOkButton.setEnabled(false);
                    showToast(getActivity(),getActivity().getString(R.string.bluetooth_name_too_long));
                }
                //*/
            }
        }
