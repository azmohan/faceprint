...
public final class BluetoothSettings extends DeviceListPreferenceFragment implements Indexable {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        mEmptyView.setPadding(0, paddingTop, 0, 0);
        mEmptyView.setCompoundDrawablesRelativeWithIntrinsicBounds(0, R.drawable.bluetooth_empty_icon, 0, 0);
