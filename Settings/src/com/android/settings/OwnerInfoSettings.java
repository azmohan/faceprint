...
public class OwnerInfoSettings extends DialogFragment implements OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if(mService.isExistData(R.string.lock_pwd_title, R.string.owner_info_settings_title)){
            mService.update(R.string.lock_pwd_title, R.string.owner_info_settings_title);
        }else{
            mService.insert(R.string.lock_pwd_title, R.string.owner_info_settings_title, this.getClass().getName(), 1, "");
        }
        //*/
    }
    ...
    public void onClick(DialogInterface dialog, int which) {
        if (which == AlertDialog.BUTTON_POSITIVE) {
            ...
            //*/ freeme.chenhanyuan. 20160622. add for Lock screen message.
            else if(getTargetFragment() instanceof LockScreenAndPassword){
                ((LockScreenAndPassword) getTargetFragment()).updateOwnerInfo();
            }
            //*/
        }
    }
