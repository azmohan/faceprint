...
//*/ Droi.xushuai,20160819,modify silead input method
    ...
    private void updateHardKeyboards() {
        ...
        for (int i = 0; i < devices.length; i++) {
            ...
            if (device != null
				...
				//*/Droi.xushuai, 20160819, modify silead input method
				if(SystemProperties.get("ro.hardware.fingerprint").equals("gsl6163e")){
	                String deviceName = device.getName();
	                Log.i("SLCODE", "InputMethodAndLanguageSettings updateHardKeyboards device name: " + 				device.getName());
