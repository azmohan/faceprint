...
public class UserDictionaryList extends SettingsPreferenceFragment {
    ...
    public void onCreate(Bundle icicle) {
        ...
        if(mService.isExistData(R.string.language_settings, R.string.user_dict_settings_title)){
            mService.update(R.string.language_settings, R.string.user_dict_settings_title);
        }else{
            mService.insert(R.string.language_settings, R.string.user_dict_settings_title, this.getClass().getName(), 1, "");
        }
        //*/
    }
