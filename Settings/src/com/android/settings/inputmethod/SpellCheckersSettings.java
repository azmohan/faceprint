...
public class SpellCheckersSettings extends SettingsPreferenceFragment
    ...
    public void onCreate(final Bundle icicle) {
        ...
        if(mService.isExistData(R.string.language_settings, R.string.spellcheckers_settings_title)){
            mService.update(R.string.language_settings, R.string.spellcheckers_settings_title);
        }else{
            mService.insert(R.string.language_settings, R.string.spellcheckers_settings_title, this.getClass().getName(), 1, "");
        }
        //*/
