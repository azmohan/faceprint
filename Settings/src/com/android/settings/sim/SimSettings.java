...
public class SimSettings extends RestrictedSettingsFragment implements Indexable,
    ...
    //*/added by tyd john for sim management
    private static final String KEY_STK_SELCETION = "stk_selcetion";
    private Preference mStkSelcetion;
    //*/
    ...
    public void onCreate(final Bundle bundle) {
       ...
       /// M: for [Smart Call Forwarding] @{
        ...
        //*/added by tyd john for stk selcetion
        mStkSelcetion = (PreferenceScreen) findPreference(KEY_STK_SELCETION);
        //*/
    }
    ...
    */
    ...
    public boolean onPreferenceTreeClick(final PreferenceScreen preferenceScreen,
        ...
        if (preference instanceof SimPreference) {
            ...
            context.startActivity(intent);
        } else if (findPreference("smart_call_fwd_key") == preference) {

            /// M: for [Smart Call Forwarding] @{
            mSimManagementExt.handleEvent(context);
            /// @}

        }
        //*/added by tyd john for entry stk
        else if(mStkSelcetion == preference){
            Intent stkIntent = new Intent("android.intent.action.MAIN");
            stkIntent.setComponent(new ComponentName("com.android.stk",
                    "com.android.stk.StkMain"));
            if(isIntentAvailable(getActivity(),stkIntent)){
                getActivity().startActivity(stkIntent);
            }else {
                Toast.makeText(getActivity(),getActivity().getResources().getString(R.string.have_no_stk), Toast.LENGTH_SHORT).show();
            }
        }
        //*/
    ...
    private class SimPreference extends RadioPowerPreference{
        ...
        public void update() {
            ...
            if (mSubInfoRecord != null) {
                //*/freeme.gejun, 20160607, only show sim name
    ...
    //*/freeme john for Judge whether the application response
