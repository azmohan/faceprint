...
//*/ freeme.xuqian,20170913,for customize battery display
...
public class BatteryHistoryChart extends View {
    ...
    //*/ freeme.xuqian,20170913,for customize battery display
    void drawLable(Canvas canvas, int width) {
        ...
        int headerTop = (mHeaderHeight - (mHeaderTextDescent + mHeaderTextAscent))/2 ;
        mHeaderTextPaint.setTextAlign(textAlignLeft);
        mHeaderTextPaint.setTextSize(32f);
