...
public class ChooseAccountActivity extends InstrumentedPreferenceActivity {
    ...
    protected void onCreate(Bundle icicle) {
        ...
        //*/ freeme. xiaocui,20160625. don't show droi account from contacts
        mFrom = getIntent().getStringExtra("packageName");
        //*/
    ...
    private void updateAuthDescriptions() {
        ...
        for (int i = 0; i < mAuthDescs.length; i++) {
            //*/Motify for tyd jiangshouting 2015.09.25 to remove QQ && IQiyi item in otherAccountAddMenu.
            //Log.i("chenhanyuan","mAuthDescs[i].type == " + mAuthDescs[i].type);
            if(mAuthDescs[i].type.equals("com.tencent.mobileqq.account") 
                ||mAuthDescs[i].type.equals("com.qiyi.video")
                //*/freeme.chenhanyuan 2016.06.13 for remove zhuoyi item.
                ||mAuthDescs[i].type.equals("com.freeme.gallery")
                ||mAuthDescs[i].type.equals("com.zhuoyou.account.android.samplesync")
                //*/
                //*/ freeme.menglingqiang, 20161017. remove Daily Express in otherAccount.
                ||mAuthDescs[i].type.equals("com.tencent.reading.account.sync")
                ||mAuthDescs[i].type.equals("com.tencent.news.account.sync")
                //*/
                ){
                continue;
            }
            ...
            //*/ freeme. xiaocui,20160625. don't show droi account from contacts
            if(mFrom != null && mFrom.equals("com.android.contacts") && mAuthDescs[i].type.equals("com.freeme.account.android.samplesync")){
            	continue;
            }
            //*/
    ...
    private void onAuthDescriptionsUpdated() {
        ...
        for (int i = 0; i < mAuthDescs.length; i++) {
            ...
            if(mAuthDescs[i].type.equals("com.tencent.mobileqq.account")
                ...
                ||mAuthDescs[i].type.equals("com.tencent.reading.account.sync")
                ||mAuthDescs[i].type.equals("com.tencent.news.account.sync")
                ||mAuthDescs[i].type.equals("com.freeme.themeclub")
                //*/
                //*/ freeme:fanwuyang on: 2017/11/03 remove email in otherAccount
                ||mAuthDescs[i].type.equals("com.android.email")
                //*/
                ){
                continue;
            }
