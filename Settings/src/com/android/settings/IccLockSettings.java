...
public class IccLockSettings extends InstrumentedPreferenceActivity
    ...
    private void iccLockChanged(boolean success, int attemptsRemaining) {
        if (success) {
            ...
            //*/ freeme.zhiwei.zhang, 20170322, night mare.
            setSimLock(mPin);
            //*/
        } else {
    ...
    //*/ freeme.zhiwei.zhang, 20170322, night mare.
    private void setSimLock(String password) {
        com.freeme.os.NightmareManager nm = com.freeme.os.NightmareManager.from(this);
        if (nm != null) {
            nm.setSimLock(mPhone.getPhoneId(), password);
        }
    }
    //*/
}
