...
public class ManageApplications extends InstrumentedFragment
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        //*/ freeme.swang merge 2017-01-09, add by mayi 2013-1-25 for:hide some apks in application manager lists.
        loadHidePackages((Context)getActivity());
        //*/
    ...
    static class ApplicationsAdapter extends BaseAdapter implements Filterable,
        ...
        private Filter mFilter = new Filter() {
            ...
            protected void publishResults(CharSequence constraint, FilterResults results) {
                ...
                //*/ freeme.swang merge 2017-01-09, add by tyd mayi 2013-1-25 for:hide some apks in application manager lists.
                removeHidePackagesFromEntries();
                //*/
                notifyDataSetChanged();
            }
        };
        ...
        ArrayList<ApplicationsState.AppEntry> applyPrefixFilter(CharSequence prefix,
            ...
            if (prefix == null || prefix.length() == 0) {
                //*/ freeme:fanwuyang on: 2017/12/02 bv3b3 hide mtk icon
                if (SystemProperties.get("ro.freeme.xlj_bv3b3").equals("1") || SystemProperties.get("ro.freeme.xlj_bv303z").equals("1") || SystemProperties.get("ro.freeme.xlj_bv3a3a").equals("1") || SystemProperties.get("ro.freeme.xlj_bv3a3h").equals("1") || SystemProperties.get("ro.freeme.xlj_bv3a3g").equals("1")) {
                    ...
                    for (int i=0; i<origEntries.size(); i++) {
                        ...
                        if((entry.info.packageName.equals("com.mediatek.thermalmanager"))
                                || (entry.info.packageName.equals("com.mediatek.mtklogger"))){
                            continue;
                        }else if((entry.label.equals("MTk"))){
                            continue;
                        }else{
                ...
                for (int i=0; i<origEntries.size(); i++) {
                    ...
                    if (nlabel.startsWith(prefixStr) || nlabel.indexOf(spacePrefixStr) != -1) {
                        /*/freeme.swang merge 2017-01-09, modify by mayi 2013-1-25 for:hide some apks in application manager lists.
                        newEntries.add(entry);
                        /*/
                        if(!checkIsInHidePackages(entry.info.packageName)){
                            newEntries.add(entry);
                        }
                        //*/ freeme:fanwuyang on: 2017/12/02 bv3b3 hide mtk icon
                        if (SystemProperties.get("ro.freeme.xlj_bv3b3").equals("1") || SystemProperties.get("ro.freeme.xlj_bv303z").equals("1") || SystemProperties.get("ro.freeme.xlj_bv3a3a").equals("1") || SystemProperties.get("ro.freeme.xlj_bv3a3h").equals("1") || SystemProperties.get("ro.freeme.xlj_bv3a3g").equals("1")){
        ...
        //*/ freeme.swang merge 2017-01-09, add  by mayi 2013-1-25 for:hide some apks in application manager lists.
        private void removeHidePackagesFromEntries() {
            if(mEntries!=null) {
                int count = mEntries.size();
                for(int i=count-1;i>=0;i--) {
                    ApplicationsState.AppEntry s = mEntries.get(i);
                    if(checkIsInHidePackages(s.info.packageName)) {
                        mEntries.remove(s);
                    }
                }
            }
    ...
    //*/ freeme.swang merge 2017-01-09, add by mayi 2013-1-25 for:hide some apks in application manager lists.
    private static String[] mHidePackages;
    private void loadHidePackages(Context context) {
        if(mHidePackages == null) {
            mHidePackages = getActivity().getResources().getStringArray(R.array.default_hide_apps);
        }
    }
    public static boolean checkIsInHidePackages(String pkgName) {
        if(mHidePackages!=null) {
            for(String pkg:mHidePackages){
