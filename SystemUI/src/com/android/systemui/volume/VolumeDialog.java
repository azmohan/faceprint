...
public class VolumeDialog {
    ...
    //*/freeme,gouzhouping,20160913,for rotation the mExpandButton disappearance.
    ...
    public VolumeDialog(Context context, int windowType, VolumeDialogController controller,
        ...
        //*/ freeme.chenming, 20161103. add notification volume icon
        addRow(AudioManager.STREAM_NOTIFICATION,
                R.drawable.ic_volume_notification, R.drawable.ic_volume_notification_mute, false);
        //*/
    ...
    private void updateRowsH() {
        ...
        for (VolumeRow row : mRows) {
            ...
            /*/ freeme.biantao, 20160621. FreemeCommon.
    ...
    private void updateFooterH() {
        ...
        //*/ Modified by droi hanhao for tyd00598352 2016-03-28
        Util.setVisOrGone(mZenFooter, false /*visible*/);
        //*/
        mZenFooter.update();
    }
