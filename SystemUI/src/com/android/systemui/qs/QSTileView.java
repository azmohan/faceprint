...
public class QSTileView extends ViewGroup {
    ...
    private int mQsTileColor;
    private int mQsTileSelectedColor;
    //*/
    ...
    public QSTileView(Context context) {
        ...
        /*/ freeme.shanjibing, 20160603. modify qs icon bigger
        mIconSizePx = res.getDimensionPixelSize(R.dimen.qs_tile_icon_size);
        mTileSpacingPx = res.getDimensionPixelSize(R.dimen.qs_tile_spacing);
        mTilePaddingBelowIconPx =  res.getDimensionPixelSize(R.dimen.qs_tile_padding_below_icon);
        //*/
        mIconSizePx = res.getDimensionPixelSize(R.dimen.droi_qs_tile_icon_size);
        mTileSpacingPx = res.getDimensionPixelSize(R.dimen.qs_tile_spacing);
        mTilePaddingBelowIconPx =  res.getDimensionPixelSize(R.dimen.freeme_qs_tile_padding_below_icon);
        //*/

        //*/ Added by Linguanrong
        mQsTileColor = res.getColor(R.color.qs_tile_text);
        mQsTileSelectedColor = res.getColor(R.color.qs_tile_text_selected);
        //*/
    ...
    private void recreateLabel() {
        ...
        if (mDual) {
            ...
            //*/ Modified by tyd Jack 20150709 for, make SustemUI support follow theme font change
            ...
            mLabel.setHorizontalFadingEdgeEnabled(true);
            mLabel.setFadingEdgeLength(6);
            //*/
    ...
    protected void handleStateChanged(QSTile.State state) {
        ...
        if (mDual) {
            ...
            //*/ Added by Linguanrong
            if(true) {
                // default color is QSTileColor
                mLabel.setTextColor(state.selected ? mQsTileSelectedColor : mQsTileColor);
            }
            //*/
