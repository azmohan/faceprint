...
public abstract class QSTile<TState extends State> implements Listenable {
    ...
    //*/ Added by droi hanhao for customized QSTile 2016-01-12
    protected static final boolean CUSTOMIZED_QSTILE = true;
    protected boolean haveGuidance = false;
    //*/
    ...
    public interface Host {
        ...
        boolean haveGuidance(String tileSpec);
        void setGuidance(String tileSpec, boolean guided);
        //*/
    ...
    public static class ResourceIcon extends Icon {
        ...
        public Drawable getDrawable(Context context) {
            ...
            //*/ Added by droi hanhao for customized QSTile 2016-01-13
    ...
    public static class State {
        ...
        public boolean copyTo(State other) {
            ...
            final boolean changed = other.visible != visible
                    ...
                    || !Objects.equals(other.dualLabelContentDescription, dualLabelContentDescription)
                    || !Objects.equals(other.selected, selected);
            //*/ Added by droi hanhao for customized QSTILE 2016-01-12
    ...
    //*/ Added by droi hanhao for customized QSTILE 2016-01-12
    public static class LevelState extends State {
        public int level;
        ...
        @Override
        public boolean copyTo(State other) {
            final LevelState o = (LevelState) other;
            final boolean changed = super.copyTo(other) || o.level != level;
            o.level = level;
            return changed;
        }
        ...
        protected StringBuilder toStringBuilder() {
            ...
            rt.insert(rt.length() - 1, ",level=" + level);
            return rt;
        }
    }
//*/
    ...
    public static final class SignalState extends State {
        ...
        public boolean defaultDataSimEmpty;
        //*/
        ...
        public boolean copyTo(State other) {
            ...
            final boolean changed = o.enabled != enabled
                    ...
                    //*/freeme.gejun, 20160705 DefaultDataSim Empty
                    || o.defaultDataSimEmpty != defaultDataSimEmpty
                    //*/
        ...
        protected StringBuilder toStringBuilder() {
            ...
            //*/freeme.gejun, 20160705 DefaultDataSim Empty
            rt.insert(rt.length() - 1, ",defaultDataSimEmpty=" + defaultDataSimEmpty);
            //*/
            return rt;
        }
    }
