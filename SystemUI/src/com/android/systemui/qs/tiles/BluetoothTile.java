...
public class BluetoothTile extends QSTile<QSTile.BooleanState>  {
    ...
    protected void handleUpdateState(BooleanState state, Object arg) {
        ...
        if(CUSTOMIZED_QSTILE) {
            if(enabled) {
                if(connected) {
                    state.icon = ResourceIcon.get(R.drawable.droi_ic_qs_bt_connected);
                } else if (connecting) {
                    state.icon = ResourceIcon.get(R.drawable.droi_ic_qs_bt_connecting);
                } else {
                    state.icon = ResourceIcon.get(R.drawable.droi_ic_qs_bt_on);
                }
            } else {
                    state.icon = ResourceIcon.get(R.drawable.droi_ic_qs_bt_off);
            }
        }
        //*/
