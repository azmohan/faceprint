...
public class RotationLockTile extends QSTile<QSTile.BooleanState> {
    ...
    protected void handleUpdateState(BooleanState state, Object arg) {
        ...
        /*/ freeme,gouzhouping. 20160806, for show the RotationLockTile view on the quick settings always.
        ...
        state.selected = !rotationLocked;
        if(CUSTOMIZED_QSTILE) {
            state.icon = ResourceIcon.get(rotationLocked ? R.drawable.droi_ic_qs_rotation_off : R.drawable.droi_ic_qs_rotation_on);
        }
        //*/
