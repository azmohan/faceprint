...
public class CellularTile extends QSTile<QSTile.SignalState> {
    ...
    public CellularTile(Host host) {
        ...
        if(CUSTOMIZED_QSTILE) {
            mDisplayDataUsage = true;
            mIcon = ResourceIcon.get(R.drawable.droi_ic_qs_data_usage);
            return;
        }
        //*/
    ...
    protected void handleClick() {
        ...
        //*/ Added by droi hanhao for goto SafeCenter when clicked 2015-07-23
        if(CUSTOMIZED_QSTILE) {
            try {
                mHost.startActivityDismissingKeyguard(new Intent("com.android.settings.ACTION_START_DATA_USES"));
            } catch (Exception e) {
                Log.e(TAG, " start SafeCenter data_uses failed, because of " + e + "\n\n So we show default whitch is in Settings ...");
