...
public class LocationTile extends QSTile<QSTile.BooleanState> {
    ...
    protected void handleUpdateState(BooleanState state, Object arg) {
        ...
        state.selected = locationEnabled;
        //*/

        // Work around for bug 15916487: don't show location tile on top of lock screen. After the
        // bug is fixed, this should be reverted to only hiding it on secure lock screens:
        // state.visible = !(mKeyguard.isSecure() && mKeyguard.isShowing());
        /*/ freeme.shanjibing, 20160705. always show location tile
        ...
        if(CUSTOMIZED_QSTILE) {
            state.icon = ResourceIcon.get(locationEnabled ? R.drawable.droi_ic_qs_gps_on : R.drawable.droi_ic_qs_gps_off);
        }
        //*/
