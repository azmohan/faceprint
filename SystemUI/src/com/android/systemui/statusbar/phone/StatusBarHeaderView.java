...
public class StatusBarHeaderView extends RelativeLayout implements View.OnClickListener,
    ...
    /*---------- Droi Configurations ----------*/
    public boolean mCustomizedHeader = false;
    /*-----------------------------------------*/

    public StatusBarHeaderView(Context context, AttributeSet attrs) {
        super(context, attrs);

        //*/ Added by droi hanhao for customized 2016-01-11
        loadDroiConfigurations(context);
        //*/
    }
    ...
    protected void onFinishInflate() {
        ...
        //*/ Added by tyd hanhao for handle Data Clock click event 2015-07-24
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        if (mCaptureValues) {
            //*/ Modified by droi hanhao for customized 2016-01-11
            if (mExpanded || mCustomizedHeader) {
            //*/
    ...
    protected void onConfigurationChanged(Configuration newConfig) {
        ...
        //*/ Added by droi hanhao for customized 2016-01-11
        if(mCustomizedHeader) {
            coreectConfigForDroi();
        }
        //*/
     ...
     * 2016-01-11
     */
    private void loadDroiConfigurations(Context context) {
        mCustomizedHeader = context.getResources().getBoolean(R.bool.config_customized_statusbar_header);
    }
    ...
    /** Added by droi hanhao for customized 2016-01-11 */
    private void coreectConfigForDroi() {
        mExpandedHeight = mCollapsedHeight;
        mMultiUserCollapsedMargin = mMultiUserExpandedMargin;
        mMultiUserSwitchWidthCollapsed = mMultiUserSwitchWidthExpanded;
        mAvatarCollapsedScaleFactor = 1f;
        mClockCollapsedSize = mClockExpandedSize = getResources().getDimensionPixelSize(R.dimen.droi_qs_time_size);
        mClockCollapsedScaleFactor = 1f;
    }
    ...
    public void updateClickable(boolean enable) {
        if(null != mDateGroup) {
            mDateGroup.setClickable(enable);
        }

        if(null != mClock) {
            mClock.setClickable(enable);
        }

        if(null != mMultiUserSwitch) {
            mMultiUserSwitch.setClickable(enable);
        }

        if(null != mSettingsButton) {
    ...
    private void updateVisibilities() {
        ...
        //*/ Modified by droi hanhao for customized 2016-01-11
        if(mCustomizedHeader) {
            mDateCollapsed.setVisibility(View.INVISIBLE);
    ...
    private void updateSystemIconsLayoutParams() {
        //*/ Added by droi hanhao for customized 2016-01-11
        if(mCustomizedHeader) {
            mSystemIconsSuperContainer.setVisibility(GONE);
            return;
        }
        //*/
    ...
    public void setExpansion(float t) {
        ...
        if(mCurrentT == t) {
            Log.d(TAG, "currentT equals the expected value: " + t + ", so return");
            return;
        }
        //*/
    ...
    public void onClick(View v) {
        ...
        //*/ Added by tyd hanhao for handle Data Clock click event 2015-07-24
            ...
            try {
                ...
                intent.setPackage("com.freeme.deskclock");
                mActivityStarter.startActivity(intent, true);
            } catch (Exception e) {
                startSettingsActivity("com.freeme.deskclock", "com.freeme.deskclock.DeskClock");
            }
        } else if (v == mDateGroup) {
            //*/ Modified by tyd hanhao for tyd00589288, 2015-12-10
            //startSettingsActivity("com.android.calendar", "com.android.calendar.AllInOneActivity");
            startSettingsActivity("com.android.freeme.calendar", "com.android.freeme.calendar.AllInOneActivity");
            //*/
        }
        //*/
    }
...
//*/ Added by tyd hanhao for handle Data Clock click event 2015-07-24
    private void startSettingsActivity(String context, String className) {
...
//*/
    ...
    public void setEmergencyCallsOnly(boolean show) {
        if (DEBUG) {
            Log.d(TAG, "setShowEmergencyCallsOnly: show= " + show +
                ...
                ", mExpanded= " + mExpanded + ", mCustomizedHeader= " + mCustomizedHeader);
        }

        //*/ Modified by droi hanhao for custimzed 2016-01-11
        boolean changed = show != mShowEmergencyCallsOnly && !mCustomizedHeader;
        //*/
        if (changed) {
    ...
    private void captureLayoutValues(LayoutValues target) {
        ...
        //*/ Modified by droi hanhao for customized 2016-01-11
        target.dateY = mCustomizedHeader ?  (mClock.getBottom() - mDateGroup.getHeight() - 6f): mDateGroup.getTop();
        //*/
        ...
        //*/ Modified by droi hanhao for customized 2016-01-11
        target.settingsTranslation = mExpanded || mCustomizedHeader
                ? 0
                : mMultiUserSwitch.getLeft() - mSettingsContainer.getLeft();
        //*/
        target.signalClusterAlpha = mSignalClusterDetached ? 0f : 1f;
        //*/ Modified by droi hanhao for customized 2016-01-11
        target.settingsRotation = !mExpanded && !mCustomizedHeader ? 90f : 0f;
        //*/
    }
