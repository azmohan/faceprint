...
public final class PhoneStatusBarTransitions extends BarTransitions {
    ...
    //*/ Added by droi hanha for customized 2016-01-14
    ...
    public void init() {
        ...
        //*/ Added by tyd hanhao foradjust layout of statusbar(signal-left),2015-07-27
        mCustomizedSignalView = mView.findViewById(R.id.customized_singnal_view);
        //*/
    ...
    private void applyMode(int mode, boolean animate) {
        ...
        if (animate) {
            ...
            anims.playTogether(
                    ...
                    //*/ Added by tyd hanhao foradjust layout of statusbar(signal-left),2015-07-27
                    animateTransitionTo(mCustomizedSignalView, newAlpha),
                    //*/
            ...
            //*/ Added by tyd hanhao foradjust layout of statusbar(signal-left),2015-07-27
            mCustomizedSignalView.setAlpha(newAlpha);
            //*/
