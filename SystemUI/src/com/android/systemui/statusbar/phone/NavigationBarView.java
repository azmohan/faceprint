...
public class NavigationBarView extends LinearLayout {
    ...
    public void onFinishInflate() {
        ...
        if (FeatureOption.FREEME_NAVIGATIONBAR_MIN) {
            mRotatedViewsEX[Surface.ROTATION_0] =
                    mRotatedViewsEX[Surface.ROTATION_180] = findViewById(R.id.rot0_ex);
            mRotatedViewsEX[Surface.ROTATION_90] = findViewById(R.id.rot90_ex);
            mRotatedViewsEX[Surface.ROTATION_270] = mRotatedViewsEX[Surface.ROTATION_90];

            mRotatedViewsEX[Surface.ROTATION_0 + 4] =
                    mRotatedViewsEX[Surface.ROTATION_180 + 4] = findViewById(R.id.rot0);
            mRotatedViewsEX[Surface.ROTATION_90 + 4] =
                    mRotatedViewsEX[Surface.ROTATION_270 + 4] = findViewById(R.id.rot90);
            mCurrentView = mRotatedViewsEX[Surface.ROTATION_0];
        }
        //*/
    ...
    public void reorient() {
        ...
        //*/ freeme.zhiwei.zhang, 20160818. NavigationBar Show/Hide.
        if (FeatureOption.FREEME_NAVIGATIONBAR_MIN) {
            for (int i = 0; i < mRotatedViewsEX.length; i++) {
                mRotatedViewsEX[i].setVisibility(View.GONE);
            }
            int type = Settings.System.getInt(mContext.getContentResolver(),
                    Settings.System.FREEME_NAVIGATIONBAR_TYPE, 0);
            if (type == 1 || type == 3) {
                mCurrentView = mRotatedViewsEX[rot + 4];
            } else {
                mCurrentView = mRotatedViewsEX[rot];
            }
        }
        //*/
    ...
    private void updateRTLOrder() {
        ...
        if (mIsLayoutRtl != isLayoutRtl) {
            ...
            //*/ freeme.zhiwei.zhang, 20160818. NavigationBar Show/Hide.
            if (FeatureOption.FREEME_NAVIGATIONBAR_MIN) {
                rotation90 = mRotatedViewsEX[Surface.ROTATION_90];
            }
            //*/
            ...
            //*/ freeme.zhiwei.zhang, 20160818. NavigationBar Show/Hide.
            if (FeatureOption.FREEME_NAVIGATIONBAR_MIN) {
                rotation270 = mRotatedViewsEX[Surface.ROTATION_270];
            }
            //*/
    ...
    */
            ...
            mRestoreButton.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View v) {
                  ...
                  // mRestoreButton.setVisibility(View.INVISIBLE);
                   ...
                   if (MultiWindowProxy.isSupported()) MultiWindowProxy.getInstance().restoreWindow(null, false);
    ...
    //*/ freeme.zhiwei.zhang, 20160818. NavigationBar Show/Hide.
    View[] mRotatedViewsEX = new View[8];

    public View getHideBarButton() {
        return mCurrentView.findViewById(R.id.hide_bar);
    }

    public void setHideButtonVisibility(boolean show) {
        if (FeatureOption.FREEME_NAVIGATIONBAR_MIN) {
            for (int i = 0; i < mRotatedViewsEX.length; i++) {
                mRotatedViewsEX[i].findViewById(R.id.hide_bar).setVisibility(show ? View.VISIBLE : View.INVISIBLE);
            }
        }
    }
    //*/
