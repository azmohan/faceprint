...
public class PanelHolder extends FrameLayout {
    ...
    private PanelHolderCallback mCallback;
    //*/
   ...
   //*/ freeme, gouzhouping, 20161129, for reboot statusbar incorrect show mess up.
   public interface PanelHolderCallback {
       public void onHeightChanged(int height);
   }
   
   public void setPanelHolderCallback(PanelHolderCallback panelHolderCallback) {
       mCallback = panelHolderCallback;
   }
   ...
   protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
       ...
       if(mCallback != null) {
           mCallback.onHeightChanged(getHeight());
       }
   }
   //*/
