...
public class LockIcon extends KeyguardAffordanceView {
   ...
   public void setIsUseDefaultLockscreen(boolean isDefault){
    ...
    public void update() {
        //*/ modify by Droi shijiachen 20150715,all comment
	...
	//*/ freeme,chenming. 20171218. Faceprint
        boolean faceprintRunning = updateMonitor.isFaceUnlockRunning(mContext.getUserId());
        //*/
	...
	/*/ freeme,chenming. 20171218. Faceprint
        ...
        /*/
        } else if (mUnlockMethodCache.isFaceUnlockRunning() || faceprintRunning) {
        //*/
