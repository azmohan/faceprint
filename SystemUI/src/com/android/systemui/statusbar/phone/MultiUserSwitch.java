...
//*/ Added by TYD Sean 2015-08-14 for droi account in status bar begin
import android.accounts.DroiAccount;
//*/ Added by TYD Sean 2015-08-14 for droi account in status bar end
...
public class MultiUserSwitch extends FrameLayout implements View.OnClickListener {
    ...
    //*/ Added by TYD Sean 2015-08-14 for droi account in status bar
    private static final boolean SHOW_DROI_ACCOUNT_STATUS_BAR = true;
    //*/
    ...
    public void onClick(View v) {
        ...
        //*/ Added by droi hanhao for droi account 2016-01-14
        else if (SHOW_DROI_ACCOUNT_STATUS_BAR) {
            DroiAccount doriAccount = DroiAccount.getInstance(getContext());
            Intent loginIntent = doriAccount.getLoginIntent();
            mQsPanel.getHost().startActivityDismissingKeyguard(loginIntent);
