...
public class KeyguardBouncer {
    ...
    private KeyguardUpdateMonitorCallback mUpdateMonitorCallback =
		 ...
		 //*/ freeme,chenming. 20171218. Faceprint
                ...
                public void onFaceUnlockStateChanged(boolean running, int userId) {
                    Log.d(TAG, "onFaceUnlockStateChanged: running = " + running);
                    if (running){
                ...
                public void onKeyguardVisibilityChanged(boolean showing) {
                    ...
                    if (!showing) {
                        ...
                        FaceprintCommand.send(mContext, FaceprintCommand.CMD_AUTHENTICATE_START);
                        updateFaceAnimState(true);
                    }
                }
                ...
                public void onStartedGoingToSleep(int why) {
                    ...
                    FaceprintCommand.send(mContext, FaceprintCommand.CMD_AUTHENTICATE_STOP);
    ...
    public void showWithDismissAction(DroiOnDismissAction r) {
        ensureView();
        mKeyguardView.setOnDismissAction(r);
        show(false /* resetSecuritySelection */);
    }

    public void showWithDismissAction(DroiOnDismissAction r, Runnable cancelAction) {
    ...
    private void updateFaceView() {
        if (isSecure()
            ...
            mFaceHasAdded = true;
            Log.d(TAG, "updateFaceView() - add face view");
        }
    }
    ...
    private void removeFaceView() {
        if (mFaceRoot != null) {
            ...
            Log.d(TAG, "removeFaceView() - really remove views.");
        }
    }

    private boolean hasUserAuthenticatedSinceBoot() {
       return KeyguardUpdateMonitor.getInstance(mContext).getStrongAuthTracker().hasUserAuthenticatedSinceBoot();
    }
    ...
    private void updateFaceAnimState(boolean running) {
        if (mFaceRoot != null) {
            Log.d(TAG, "updateFaceAnimState() running: " + running + "mHasAnimationRunning: " + mHasAnimationRunning);
