...
public class KeyguardBottomAreaView extends FrameLayout implements View.OnClickListener,
    ...
    //*/ added by Droid shijiachen 2015-7-24 for customize keyguard
    private boolean misUseDefaultLockscreen = true;
    //*/
  ...
  //*/added by Droi shijiachen 20150724 for  customize keyguard
    public void setIsUseDefaultLockscreen(boolean isDefault){
        misUseDefaultLockscreen = isDefault;
        if(isDefault){
    ...
    private void updateCameraVisibility() {
        ...
        boolean visible = !isCameraDisabledByDpm() && resolved != null
                ...
                && mUserSetupComplete;
       //*/ modify  by Droi fenglei for customize keyguard
        if(misUseDefaultLockscreen){
    ...
    private void updateLeftAffordanceIcon() {
        ...
        //*/ modify by Droi fenglei 2016-01-20 for customize keyguard
        if(misUseDefaultLockscreen){
	...
	//*/ freeme,chenming. 20171218. Faceprint
        KeyguardUpdateMonitor updateMonitor = KeyguardUpdateMonitor.getInstance(mContext);
        if (updateMonitor.hasEnrolledFace()) {
            updateMonitor.updateFaceService(false);
        }
        //*/
