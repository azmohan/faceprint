...
public class ScrimController implements ViewTreeObserver.OnPreDrawListener,
        ...
        //*/ Added by droi hanhao for fix headsUpNotificaiton 2016-03-17
	...
	//*/Added by shijiachen 20150722 for keyguard
    public ScrimView getBehind(){
    	return mScrimBehind;
    }
    
    public void setStatusBarState(int state){
    	if(mScrimBehind != null){
    		mScrimBehind.setStatusBarState(state);
    	}
    	if(mScrimInFront != null){
    		mScrimInFront.setStatusBarState(state);
    	}
    }
    
    public void setDefaultLockscreen(boolean isDefault){
    	if(mScrimBehind != null){
    		mScrimBehind.setDefaultLockscreen(isDefault);
    	}
    	if(mScrimInFront != null){
    		mScrimInFront.setDefaultLockscreen(isDefault);
    	}
    }
    
    public void setEnable(boolean enable){
    	if(mScrimBehind != null){
    		mScrimBehind.setScrimEnable(enable);
    	}
    	if(mScrimInFront != null){
    		mScrimInFront.setScrimEnable(enable);
    	}
    }
	//*/
    ...
    public void onHeadsUpPinned(ExpandableNotificationRow headsUp) {
        mPinnedHeadsUpCount++;
        //*/ Added by droi hanhao for fix headsUpNotificaiton 2016-03-17
        headsUp.addExtOnHeightChangedListener(this);
        //*/
    ...
    public void onHeadsUpUnPinned(ExpandableNotificationRow headsUp) {
        ...
        //*/ Added by droi hanhao for fix headsUpNotificaiton 2016-03-17
        headsUp.removeExtOnHeightChangedListener(this);
        //*/
        updateHeadsUpScrim(true);
    }
    ...
    //*/ Added by droi hanhao for fix headsUpNotificaiton 2016-03-17
    private void fixHeadsUpScrimHeight(ExpandableNotificationRow headsUp){        
        ViewGroup.LayoutParams layoutParams = mHeadsUpScrim.getLayoutParams();
        layoutParams.height =
                (headsUp == null) ? 
                        (int)mHeadsUpScrim.getContext().getResources().getDimensionPixelSize(R.dimen.heads_up_scrim_height)
                        : (int)(headsUp.getMaxHeadsUpHeight() * 1.1f);
        Log.d(TAG, "MaxHeadsUpHeight = " + headsUp.getMaxHeadsUpHeight());
