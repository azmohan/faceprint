...
public class NotificationOverflowIconsView extends IconMerger {
    ...
    public void setMoreText(TextView moreText) {
        ...
        //*/ Added by tyd hanhao, change its style as a unified. 2015-08-04
        mMoreText.setBackgroundColor(com.android.internal.R.color.transparent);
        mMoreText.setElevation(4.0F);
        //mMoreText.setShadowLayer(2, 0, 0, getResources().getColor(com.android.internal.R.color.notification_icon_bg_color));
        //*/
    }
