...
public abstract class ActivatableNotificationView extends ExpandableOutlineView {
    ...
    //*/ Added by droi hanhao fro customized 2016-01-21
    private boolean mForceActivated;
    //*/
    ...
    private boolean handleTouchEventDimmed(MotionEvent event) {
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_UP:
                if (isWithinTouchSlop(event)) {
                    if (!mActivated) {
                        //*/ Modified by tyd hanhao for disable active_state(click twice to open a notification) in normal keyguard 2015-11-26 
                        if(mForceActivated) {
    ...
    public void makeForceActive(boolean forced) {
        this.mForceActivated = forced;
    }
    //*/
    ...
    public void setDimmedBackground(boolean inDefaultLockScreen) {
        mBackgroundDimmed.setCustomBackground(inDefaultLockScreen ?
                    R.drawable.droi_notification_material_bg_dim : R.drawable.notification_material_bg_dim);
        updateBackground();
    }
    //*/
