...
public abstract class ExpandableView extends FrameLayout {
    ...
    private ArrayList<OnHeightChangedListener> mExtHeightChangedListeners =
            new ArrayList<OnHeightChangedListener>();
    //*/
    ...
    //*/ Added by droi hanhao for fix headsUpNotificaiton 2016-03-17
    public void addExtOnHeightChangedListener(OnHeightChangedListener listener) {
        if(mExtHeightChangedListeners.contains(listener)) {
            return;
        }
        mExtHeightChangedListeners.add(listener);
    }
    public void removeExtOnHeightChangedListener(OnHeightChangedListener listener) {
        if(mExtHeightChangedListeners.contains(listener)) {
            mExtHeightChangedListeners.remove(listener);
        }
    }
    //*/
    ...
    public void notifyHeightChanged(boolean needsAnimation) {
        ...
        //*/ Added by droi hanhao for fix headsUpNotificaiton 2016-03-17
        for(OnHeightChangedListener listener : mExtHeightChangedListeners) {
            listener.onHeightChanged(this, needsAnimation);
        }
        //*/
    }
