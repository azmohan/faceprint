...
public class DragDownHelper implements Gefingerpoken {
    ...
    //*/add by  Droi  shijiachen 2015-7-24 for customize keyguard
    private boolean mIsEnableNotificationSlop = false;
    private boolean mIsDefaultLockscreen = true;
    //*/
    ...
    public boolean onInterceptTouchEvent(MotionEvent event) {
        ...
        switch (event.getActionMasked()) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                //*/modified by Droi  shijiachen 2015-7-24 for customize keyguard
                if(mIsDefaultLockscreen){
                	 ...
                	 if (h > mTouchSlop && h > Math.abs(x - mInitialTouchX)&&mIsEnableNotificationSlop) {
                      //  if (h > mTouchSlop && h > Math.abs(x - mInitialTouchX)) {
                           mDraggingDown = true;
                           captureStartingChild(mInitialTouchX, mInitialTouchY);
                           mInitialTouchY = y;
    ...
    public void setIsDefaultLockscreen(boolean isDefault) {
		this.mIsDefaultLockscreen = isDefault;
		Log.d("fenglei", "setIsDefaultLockscreen-->>mIsDefaultLockscreen: "+isDefault);
	}
    //*/
