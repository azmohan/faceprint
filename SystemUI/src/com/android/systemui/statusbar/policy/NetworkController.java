...
public interface NetworkController {
    ...
    public static class DroiIconState extends IconState{
        public final int mobileUpIcon;
        public final int mobileDownIcon;
        public DroiIconState(boolean visible, int icon,
                String contentDescription,int mobileUpIcon,int mobileDownIcon) {
            super(visible, icon, contentDescription);
            this.mobileUpIcon = mobileUpIcon;
            this.mobileDownIcon = mobileDownIcon;
            }
    }
    //*/
    ...
    public interface MobileDataController {
        ...
        void updateMobileDtatState(boolean enabled);
        //*/
