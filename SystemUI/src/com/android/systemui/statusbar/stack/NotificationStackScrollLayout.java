...
public class NotificationStackScrollLayout extends ViewGroup
    ...
    private DroiDismissViewButton mExtDismissView;
    //*/
    ...
    //*/added by shijiachen 20150819 for change the visibility of the notification in keyguard
    public void setDismissViewVisible(int visible){
        if(mDismissView != null){
            mDismissView.setVisibility(visible);
        }

        //*/ Added by droi hanhao for customized 2016-03-03
        if(null != mExtDismissView) {
            mExtDismissView.setVisibility(visible);
        }
        //*/
    }
    
    public void setNotificationVisible(int visible){
        final int count = getChildCount();
        for (int childIdx = 0; childIdx < count; childIdx++) {
            View v = getChildAt(childIdx);
            if(v instanceof ExpandableNotificationRow ||v instanceof NotificationOverflowContainer || v instanceof DismissView){
                v.setVisibility(visible);
            }
        }
    }
    
    public void setNotificationOverflowViewVisible(int visible){
         final int count = getChildCount();
         for (int childIdx = 0; childIdx < count; childIdx++) {
            View v = getChildAt(childIdx);
            if(v instanceof NotificationOverflowContainer){
                v.setVisibility(visible);
                break;
            }
         }
    ...
    private void onViewAddedInternal(View child) {
        ...
        if (canChildBeDismissed(child)) {
            ...
            //*/ Added by droi hanhao for customized dismissButton 2016-01-21
            if(null != mExtDismissView) {
                if(mExtDismissView.getVisibility() != View.VISIBLE) {
                    mExtDismissView.setVisibility(View.VISIBLE);
                }
            }
            //*/
        }
    ...
    private void generateChildHierarchyEvents() {
        ...
        //*/ freeme.shanjibing, 20160613. modify notifications overlap(do not animate)
        //generateDragEvents();
        //*/
    ...
    private void applyCurrentState() {
        //*/ Modified by droi hanhao 2016-03-08
        if(null != mExtDismissView) {
            boolean trackingHeadsUp = mTrackingHeadsUp || mHeadsUpManager.hasPinnedHeadsUp();
            mCurrentStackScrollState.apply(mExtDismissView, trackingHeadsUp);
        } else {
    ...
    //*/ Added by droi hanhao for customized dismissButton 2016-01-21
    public void addExtDismissView(DroiDismissViewButton extDidmissView) {
        mExtDismissView = extDidmissView;
    }
    //*/
    ...
    public void updateDismissView(boolean visible) {
        ...
        if(visible) {
            ...
            mExtDismissView.setVisibility(View.GONE);
        }
        //*/
    }
