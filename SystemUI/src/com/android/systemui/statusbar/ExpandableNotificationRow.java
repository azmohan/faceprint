...
public class ExpandableNotificationRow extends ActivatableNotificationView {
    ...
    //*/ Added by droi hanhao for fix headsUpNotificaiton 2016-03-17
    public int getMaxHeadsUpHeight() {
        return mMaxHeadsUpHeight;
    }
    //*/
    ...
    private void updateMaxHeights() {
        ...
        //*/ Modified by droi hanhao for fix headsUpNotificaiton 2016-03-17
        if (headsUpChild == null) {
            headsUpChild = mPrivateLayout.getContractedChild();
            mMaxHeadsUpHeight = Math.max(mMaxHeadsUpHeight, headsUpChild.getHeight());
        } else {
            mMaxHeadsUpHeight = Math.max(mMaxHeadsUpHeight, headsUpChild.getHeight());
        }
        //*/
