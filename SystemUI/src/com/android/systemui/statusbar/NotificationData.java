...
public class NotificationData {
    ...
    private final Comparator<Entry> mRankingComparator = new Comparator<Entry>() {
        ...
        public int compare(Entry a, Entry b) {
            ...
            /*/ Added by tyd hanhao ,for custom  sbn order, 2015-11-30
            boolean aClearable = a.notification.isClearable();
            boolean bClearable = b.notification.isClearable();
            if(aClearable != bClearable) {
                return aClearable ? 1 : -1;
            }
            //*/
            ...
            /*/ Added by tyd hanhao, add a local preferential list for sort notifications 2015-12-07
            boolean aPreferential = isPreferentialNotification(na);
            boolean bPreferential = isPreferentialNotification(nb);

            if(aPreferential != bPreferential) {
                return aPreferential ? -1 : 1;
            }
            //*/
    ...
    //*/ Added by tyd hanhao, add a local preferential list for sort notifications 2015-12-07
    private static boolean isPreferentialNotification(StatusBarNotification sbn) {
        String sbnPackage = sbn.getPackageName();
        return
            "com.android.dialer".equals(sbnPackage) ||
            "com.android.mms".equals(sbnPackage);
    }
    //*/
