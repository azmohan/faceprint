...
public class DismissViewButton extends Button {
    ...
    private static final boolean CUSTOMIZED_BUTTON = true;
    //*/
    ...
    protected void onDraw(Canvas canvas) {
        ...
        //Never show dismissButton, which is show in last notificationRaw.
        //If you want show this, just let this part of the code execution.
        if(false == CUSTOMIZED_BUTTON) {
            canvas.save();
            ...
            setBackgroundColor(com.android.internal.R.color.transparent);
        }
        //*/
    }
