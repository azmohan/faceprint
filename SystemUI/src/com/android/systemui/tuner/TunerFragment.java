...
public class TunerFragment extends PreferenceFragment {
    ...
    private final OnPreferenceChangeListener mBatteryPctChange = new OnPreferenceChangeListener() {
        ...
        public boolean onPreferenceChange(Preference preference, Object newValue) {
            ...
            //*/ Modified by droi hanhao for customized 2016-01-22
            //System.putInt(getContext().getContentResolver(), SHOW_PERCENT_SETTING, v ? 1 : 0);
            
            ContentResolver contentResolver = getContext().getContentResolver();
            String blackListStr = Secure.getString(contentResolver, StatusBarIconController.ICON_BLACKLIST);
            Set<String> blackList = StatusBarIconController.getIconBlacklist(blackListStr);
            if(v) {
                blackList.remove("batteryperc");
            } else {
                if(!blackList.contains("batteryperc")) {
                    blackList.add("batteryperc");
                }
            }
            Secure.putString(contentResolver, StatusBarIconController.ICON_BLACKLIST,
