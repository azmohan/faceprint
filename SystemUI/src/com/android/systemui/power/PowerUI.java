...
public class PowerUI extends SystemUI {
    ...
    //*/ freeme.shanjibing, 20160612. play sound use soundpool
    static final int POWER_CONNECT_SOUND = 1;
    static final int POWER_FULL_SOUND = 2;
    ...
    public void start() {
        ...
        mSounds = new SoundPool.Builder()
                ...
                .setAudioAttributes(new AudioAttributes.Builder()
                        ...
                        .build())
                .build();
        //mSounds = new SoundPool(1, AudioManager.STREAM_SYSTEM_ENFORCED, 0);
        String powerFullSoundPath =Settings.Global.getString(resolver, Settings.Global.POWER_FULL);
        if ( powerFullSoundPath != null ) {
            mPwrFullSoundId = mSounds.load(powerFullSoundPath, 1);
        }
        String powerConnSoundPath = Settings.Global.getString(resolver, Settings.Global.POWER_CONNECT);
    ...
    private final class Receiver extends BroadcastReceiver {
        ...
        public void init() {
            ...
            //*/ freeme.shanjibing, 20160531. add action:ACTION_POWER_CONNECTED
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (action.equals(Intent.ACTION_BATTERY_CHANGED)) {
                ...
                //*/ freeme.shanjibing, 20160531. add sound for BATTERY_STATUS_FULL.
                if (mBatteryStatus == BatteryManager.BATTERY_STATUS_FULL && 
                    mBatteryStatus != oldBatteryStatus) {
                    playPowerNotificationSound(POWER_FULL_SOUND);
                }
            ...
            //*/ freeme.shanjibing, 20160530. add sound for usb connect.
                ...
                if (mIgnoreFirstPowerEvent) {
                    ...
                    playPowerNotificationSound(POWER_CONNECT_SOUND);
                }
            //*/
            } else {
    ...
    //*/ freeme.shanjibing, 20160612. play sound use soundpool
    void playPowerNotificationSound(int selection) {
        switch (selection) {
            case POWER_CONNECT_SOUND:
