...
//*/Added by tyd Sean 20160112 for: import ImageView
...
public class SwipeHelper implements Gefingerpoken {
    ...
    private boolean mLockNotChanged;
	//*/
    ...
    private void updateSwipeProgressFromOffset(View animView, boolean dismissable) {
        ...
        //*/ Added by TYD hongchang.han 2015-10-21
        if (!dismissable) {
        	// Math(x,3) to set the alpha
        	mCallback.updateCircleViewAlpha(swipeProgress * swipeProgress * swipeProgress);
        }

        ImageView lockView = (ImageView) getChildLockFabView(animView);
        if (getTranslation(animView) > (animView.getMeasuredHeight() * 0.1f)) {
        	if (mLockNotChanged) {
        	    mCallback.updateChildLockState(mCurrView);
        	    mLockNotChanged = false;
        	}
        }
        //*/ TYD
    }
    ...
    public void snapChild(final View view, float velocity) {
        final View animView = mCallback.getChildContentView(view);
        //*/Modified by tyd Sean 20160112 for: change target view
        final boolean canAnimViewBeDismissed = mCallback.canChildBeDismissed(view);
        //*/
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        ...
        if (!mDragging) {
            if (mCallback.getChildAtPosition(ev) != null) {
                ...
                //*/ Modified by hongchang.han.2015.10.15. If return true, ScrollView will never response
                return false;
                //*/
            } else {
            ...
            case MotionEvent.ACTION_MOVE:
                if (mCurrView != null) {
                    ...
                    if (CONSTRAIN_SWIPE && !mCallback.canChildBeDismissed(mCurrView)) {
                        ...
                        float maxScrollDistance = 0.2f * size;
						//*/
                        if (absDelta >= size) {
                    ...
                    //*/Added by tyd Sean 20160112 for: canChildBeDismissed
                    mCanCurrViewBeDimissed = mCallback.canChildBeDismissed(mCurrView);
                    //*/
    ...
    public interface Callback {
        ...
        //*/ Added by TYD hongchang.han
        void updateChildLockState(View v);
        void updateCircleViewAlpha(float alpha);
        //*/
    }
