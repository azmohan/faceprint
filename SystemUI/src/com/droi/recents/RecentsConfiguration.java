...
import com.droi.recents.misc.Console;
...
public class RecentsConfiguration {
    ...
    void update(Context context) {
        ...
        hasTransposedSearchBar = res.getBoolean(R.bool.droi_recents_has_transposed_search_bar);
        hasTransposedNavBar = res.getBoolean(R.bool.droi_recents_has_transposed_nav_bar);
        ...
        filteringCurrentViewsAnimDuration =
                res.getInteger(R.integer.droi_recents_filter_animate_current_views_duration);
        filteringNewViewsAnimDuration =
                res.getInteger(R.integer.droi_recents_filter_animate_new_views_duration);

        // Loading
        maxNumTasksToLoad = ActivityManager.getMaxRecentTasksStatic();

        // Search Bar
        searchBarSpaceHeightPx = res.getDimensionPixelSize(R.dimen.droi_recents_search_bar_space_height);

        // Task stack
        taskStackScrollDuration =
                res.getInteger(R.integer.droi_recents_animate_task_stack_scroll_duration);
        taskStackWidthPaddingPct = res.getFloat(R.dimen.droi_recents_stack_width_padding_percentage);
        taskStackOverscrollPct = res.getFloat(R.dimen.droi_recents_stack_overscroll_percentage);
        taskStackMaxDim = res.getInteger(R.integer.droi_recents_max_task_stack_view_dim);
        taskStackTopPaddingPx = res.getDimensionPixelSize(R.dimen.droi_recents_stack_top_padding);
        dismissAllButtonSizePx = res.getDimensionPixelSize(R.dimen.droi_recents_dismiss_all_button_size);

        // Transition
        transitionEnterFromAppDelay =
                res.getInteger(R.integer.droi_recents_enter_from_app_transition_duration);
        transitionEnterFromHomeDelay =
                res.getInteger(R.integer.droi_recents_enter_from_home_transition_duration);

        // Task view animation and styles
        taskViewEnterFromAppDuration =
                res.getInteger(R.integer.droi_recents_task_enter_from_app_duration);
        taskViewEnterFromHomeDuration =
                res.getInteger(R.integer.droi_recents_task_enter_from_home_duration);
        taskViewEnterFromHomeStaggerDelay =
                res.getInteger(R.integer.droi_recents_task_enter_from_home_stagger_delay);
        taskViewExitToAppDuration =
                res.getInteger(R.integer.droi_recents_task_exit_to_app_duration);
        taskViewExitToHomeDuration =
                res.getInteger(R.integer.droi_recents_task_exit_to_home_duration);
        taskViewRemoveAnimDuration =
                res.getInteger(R.integer.droi_recents_animate_task_view_remove_duration);
        taskViewRemoveAnimTranslationXPx =
                res.getDimensionPixelSize(R.dimen.droi_recents_task_view_remove_anim_translation_x);
        taskViewRoundedCornerRadiusPx =
                res.getDimensionPixelSize(R.dimen.droi_recents_task_view_rounded_corners_radius);
        taskViewHighlightPx = res.getDimensionPixelSize(R.dimen.droi_recents_task_view_highlight);
        taskViewTranslationZMinPx = res.getDimensionPixelSize(R.dimen.droi_recents_task_view_z_min);
        taskViewTranslationZMaxPx = res.getDimensionPixelSize(R.dimen.droi_recents_task_view_z_max);
        taskViewAffiliateGroupEnterOffsetPx =
                res.getDimensionPixelSize(R.dimen.droi_recents_task_view_affiliate_group_enter_offset);
        taskViewThumbnailAlpha = res.getFloat(R.dimen.droi_recents_task_view_thumbnail_alpha);
        ...
        taskBarViewAffiliationColorMinAlpha = res.getFloat(
                R.dimen.droi_recents_task_affiliation_color_min_alpha_percentage);

        // Task bar size & animations
        taskBarHeight = res.getDimensionPixelSize(R.dimen.droi_recents_task_bar_height);
        taskBarDismissDozeDelaySeconds =
                res.getInteger(R.integer.droi_recents_task_bar_dismiss_delay_seconds);

        // Nav bar scrim
        navBarScrimEnterDuration =
                res.getInteger(R.integer.droi_recents_nav_bar_scrim_enter_duration);

        // Misc
        useHardwareLayers = res.getBoolean(R.bool.droi_config_recents_use_hardware_layers);
        altTabKeyDelay = res.getInteger(R.integer.droi_recents_alt_tab_key_delay);
        fakeShadows = res.getBoolean(R.bool.droi_config_recents_fake_shadows);
        svelteLevel = res.getInteger(R.integer.droi_recents_svelte_level);
    }
