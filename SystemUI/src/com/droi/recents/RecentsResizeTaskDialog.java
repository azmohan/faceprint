...
import com.droi.recents.RecentsActivity;
...
public class RecentsResizeTaskDialog extends DialogFragment {
    ...
    private static final int[][] BUTTON_DEFINITIONS =
           {{R.id.droi_place_left, PLACE_LEFT},
            {R.id.droi_place_right, PLACE_RIGHT},
            {R.id.droi_place_top, PLACE_TOP},
            {R.id.droi_place_bottom, PLACE_BOTTOM},
            {R.id.droi_place_top_left, PLACE_TOP_LEFT},
            {R.id.droi_place_top_right, PLACE_TOP_RIGHT},
            {R.id.droi_place_bottom_left, PLACE_BOTTOM_LEFT},
            {R.id.droi_place_bottom_right, PLACE_BOTTOM_RIGHT},
            {R.id.droi_place_full, PLACE_FULL}};
    ...
    private void createResizeTaskDialog(final Context context, LayoutInflater inflater,
        ...
        builder.setTitle(R.string.droi_recents_caption_resize);
        mResizeTaskDialogContent =
                inflater.inflate(R.layout.droi_recents_task_resize_dialog, null, false);
        ...
        builder.setNegativeButton(R.string.droi_cancel, new DialogInterface.OnClickListener() {
            @Override
