...
import com.droi.recents.model.RecentsTaskLoadPlan;
import com.droi.recents.model.RecentsTaskLoader;
import com.droi.recents.model.Task;
import com.droi.recents.model.TaskGrouping;
import com.droi.recents.model.TaskStack;
import com.droi.recents.views.TaskStackView;
import com.droi.recents.views.TaskStackViewLayoutAlgorithm;
import com.droi.recents.views.TaskViewHeader;
import com.droi.recents.views.TaskViewTransform;
...
public class Recents extends SystemUI
    ...
    public final static String sRecentsActivity = "com.droi.recent.RecentsActivity";
    ...
    //Added by Sean 2015-12-11 for provide interface to set last toggle time begin
    public void setmLastToggleTime(long lastToggleTime){
        mLastToggleTime = lastToggleTime;
    }
    //Added by Sean 2015-12-11 for provide interface to set last toggle time end
            ...
            if (task.key.id == runningTask.id) {
                ...
                if (showNextTask) {
                    ...
                    launchOpts = ActivityOptions.makeCustomAnimation(mContext,
                            R.anim.droi_recents_launch_next_affiliated_task_target,
                            R.anim.droi_recents_launch_next_affiliated_task_source);
                } else {
                    toTaskKey = group.getPrevTaskInGroup(task);
                    launchOpts = ActivityOptions.makeCustomAnimation(mContext,
                            R.anim.droi_recents_launch_prev_affiliated_task_target,
                            R.anim.droi_recents_launch_prev_affiliated_task_source);
                }
                if (toTaskKey != null) {
                ...
                if (showNextTask) {
                    mSystemServicesProxy.startInPlaceAnimationOnFrontMostApplication(
                            ActivityOptions.makeCustomInPlaceAnimation(mContext,
                                    R.anim.droi_recents_launch_next_affiliated_task_bounce));
                } else {
                    mSystemServicesProxy.startInPlaceAnimationOnFrontMostApplication(
                            ActivityOptions.makeCustomInPlaceAnimation(mContext,
                                    R.anim.droi_recents_launch_prev_affiliated_task_bounce));
                }
            }
            return;
        }
    ...
    void reloadHeaderBarLayout() {
        ...
        int taskBarHeight = res.getDimensionPixelSize(R.dimen.droi_recents_task_bar_height);
        synchronized (mHeaderBarLock) {
            mHeaderBar = (TaskViewHeader) mInflater.inflate(R.layout.droi_recents_task_view_header, null,
                    false);
            mHeaderBar.measure(
    ...
    ActivityOptions getUnknownTransitionActivityOptions() {
        ...
        return ActivityOptions.makeCustomAnimation(mContext,
                R.anim.droi_recents_from_unknown_enter,
                R.anim.droi_recents_from_unknown_exit,
                mHandler, this);
    }
    ...
    ActivityOptions getHomeTransitionActivityOptions(boolean fromSearchHome) {
        ...
        if (fromSearchHome) {
            return ActivityOptions.makeCustomAnimation(mContext,
                    R.anim.droi_recents_from_search_launcher_enter,
                    R.anim.droi_recents_from_search_launcher_exit,
                    mHandler, this);
        }
        return ActivityOptions.makeCustomAnimation(mContext,
                R.anim.droi_recents_from_launcher_enter,
                R.anim.droi_recents_from_launcher_exit,
                mHandler, this);
    }
    ...
    void startAlternateRecentsActivity(ActivityManager.RunningTaskInfo topTask,
        ...
        //Modified by Sean 2015-12-10 for revemo enter animation begin
        if (false && opts != null) {
            mContext.startActivityAsUser(intent, opts.toBundle(), UserHandle.CURRENT);
        } else {
            mContext.startActivityAsUser(intent, UserHandle.CURRENT);
        }
        //Modified by Sean 2015-12-10 for revemo enter animation end
