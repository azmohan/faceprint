...
class FakeShadowDrawable extends Drawable {
    ...
    public FakeShadowDrawable(Resources resources, RecentsConfiguration config) {
        mShadowStartColor = resources.getColor(R.color.droi_fake_shadow_start_color);
        mShadowEndColor = resources.getColor(R.color.droi_fake_shadow_end_color);
        mInsetShadow = resources.getDimension(R.dimen.fake_shadow_inset);
        setShadowSize(resources.getDimensionPixelSize(R.dimen.droi_fake_shadow_size),
                resources.getDimensionPixelSize(R.dimen.droi_fake_shadow_size));
