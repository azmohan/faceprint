...
public class TaskView extends FrameLayout implements Task.TaskCallbacks,
    ...
    protected void onFinishInflate() {
        // Bind the views
        mContent = findViewById(R.id.droi_task_view_content);
        mHeaderView = (TaskViewHeader) findViewById(R.id.droi_task_view_bar);
        mThumbnailView = (TaskViewThumbnail) findViewById(R.id.droi_task_view_thumbnail);
        mThumbnailView.updateClipToTaskBar(mHeaderView);
        mActionButtonView = findViewById(R.id.droi_lock_to_app_fab);
