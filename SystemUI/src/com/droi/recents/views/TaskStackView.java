...
import com.droi.recents.misc.DozeTrigger;
import com.droi.recents.misc.SystemServicesProxy;
import com.droi.recents.misc.Utilities;
import com.droi.recents.model.RecentsPackageMonitor;
...
public class TaskStackView extends FrameLayout implements TaskStack.TaskStackCallbacks,
        ...
        if (mStackViewsDirty) {
            ...
            if (Constants.DebugFlags.App.EnableDismissAll && mDismissAllButton == null) {
                mDismissAllButton = (DismissView)
                        mInflater.inflate(R.layout.droi_recents_dismiss_button, this, false);
    ...
    void showDismissAllButton() {
        ...
        if (mDismissAllButtonAnimating || mDismissAllButton.getVisibility() != View.VISIBLE ||
            ...
            mDismissAllButton.findViewById(R.id.droi_dismiss_text).setAlpha(1f);
    ...
    public void onStackAllTasksRemoved(TaskStack stack, final ArrayList<Task> removedTasks) {
        ...
        String msg = getContext().getString(R.string.droi_accessibility_recents_all_items_dismissed);
    ...
    public TaskView createView(Context context) {
        return (TaskView) mInflater.inflate(R.layout.droi_recents_task_view, this, false);
    }
    ...
    public void onTaskViewDismissed(TaskView tv) {
        ...
        // Announce for accessibility
        tv.announceForAccessibility(getContext().getString(R.string.droi_accessibility_recents_item_dismissed,
