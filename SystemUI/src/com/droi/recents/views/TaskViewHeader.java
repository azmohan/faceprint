...
package com.droi.recents.views;
...
public class TaskViewHeader extends FrameLayout {
    ...
    public TaskViewHeader(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        mLightDismissDrawable = context.getDrawable(R.drawable.droi_recents_dismiss_light);
        mDarkDismissDrawable = context.getDrawable(R.drawable.droi_recents_dismiss_dark);
        mDismissContentDescription =
                context.getString(R.string.droi_accessibility_recents_item_will_be_dismissed);
    ...
    protected void onFinishInflate() {
        ...
        mApplicationIcon = (ImageView) findViewById(R.id.droi_application_icon);
        mActivityDescription = (TextView) findViewById(R.id.droi_activity_description);
        mDismissButton = (ImageView) findViewById(R.id.droi_dismiss_task);
        mMoveTaskButton = (ImageView) findViewById(R.id.droi_move_task);
        ...
        mBackground = (RippleDrawable)
                getContext().getDrawable(R.drawable.droi_recents_task_view_header_bg);
    ...
    void updateResizeTaskBarIcon(Task t) {
        ...
        int resId = R.drawable.droi_star;
        if (display.equals(taskRect) || taskRect.isEmpty()) {
            resId = R.drawable.droi_vector_drawable_place_fullscreen;
        } else {
            ...
            if (top && bottom && left) {
                resId = R.drawable.droi_vector_drawable_place_left;
            } else if (top && bottom && right) {
                resId = R.drawable.droi_vector_drawable_place_right;
            } else if (top && left && right) {
                resId = R.drawable.droi_vector_drawable_place_top;
            } else if (bottom && left && right) {
                resId = R.drawable.droi_vector_drawable_place_bottom;
            } else if (top && right) {
                resId = R.drawable.droi_vector_drawable_place_top_right;
            } else if (top && left) {
                resId = R.drawable.droi_vector_drawable_place_top_left;
            } else if (bottom && right) {
                resId = R.drawable.droi_vector_drawable_place_bottom_right;
            } else if (bottom && left) {
                resId = R.drawable.droi_vector_drawable_place_bottom_left;
            }
        }
