...
import com.droi.recents.misc.DebugTrigger;
import com.droi.recents.misc.ReferenceCountedTrigger;
...
import com.droi.recents.views.DebugOverlayView;
import com.droi.recents.views.RecentsView;
import com.droi.recents.views.SystemBarScrimViews;
import com.droi.recents.views.ViewAnimation;
...
public class RecentsActivity extends Activity implements RecentsView.RecentsViewCallbacks,
            ...
            if (mLaunchIntent != null) {
                try {
                    ...
                    Console.logError(RecentsActivity.this,
                            getString(R.string.droi_recents_launch_error_message, "Home"));
                }
                /// M: add for multi window @{
                if (FLOAT_WINDOW_SUPPORT) {
                    finish();
                    overridePendingTransition(R.anim.droi_recents_to_launcher_enter,
                        R.anim.droi_recents_to_launcher_exit);
                }
                /// @}
            } else {
                finish();
    ...
    void updateRecentsTasks() {
        ...
        mFinishLaunchHomeRunnable = new FinishRecentsRunnable(homeIntent,
            ActivityOptions.makeCustomAnimation(this,
                mConfig.launchedFromSearchHome ? R.anim.droi_recents_to_search_launcher_enter :
                        R.anim.droi_recents_to_launcher_enter,
                    mConfig.launchedFromSearchHome ? R.anim.droi_recents_to_search_launcher_exit :
                        R.anim.droi_recents_to_launcher_exit));
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.droi_recents);
        mRecentsView = (RecentsView) findViewById(R.id.droi_recents_view);
        mRecentsView.setCallbacks(this);
        mRecentsView.setSystemUiVisibility(View.SYSTEM_UI_FLAG_LAYOUT_STABLE |
                View.SYSTEM_UI_FLAG_LAYOUT_FULLSCREEN |
                View.SYSTEM_UI_FLAG_LAYOUT_HIDE_NAVIGATION);
        mEmptyViewStub = (ViewStub) findViewById(R.id.droi_empty_view_stub);
        mDebugOverlayStub = (ViewStub) findViewById(R.id.droi_debug_overlay_stub);
