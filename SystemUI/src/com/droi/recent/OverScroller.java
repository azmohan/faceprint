...
public class OverScroller {
	  private int mMode;
	    ...
	    //*/freeme, gouzhouping, 20161021, for refactor
	    private static int RECENT_ITEM_WIDTH;
	    private static int LEFT_SCROLL;
	    private static int HIDE_PART;
	    //*/
	    ...
	    static class SplineOverScroller {
	        ...
	        void fling(int start, int velocity, int min, int max, int over) {
	            ...
	            if (true) {
	                if (velocity < 0) {
	                    // finger right
	                    int num =  mFinal/RECENT_ITEM_WIDTH; 
	                    mFinal = num * RECENT_ITEM_WIDTH - LEFT_SCROLL;
	                } else {
	                    // finger left
	                    int num = mFinal/RECENT_ITEM_WIDTH;
	                    if (mFinal % RECENT_ITEM_WIDTH <= 300) {
	                        mFinal = num * RECENT_ITEM_WIDTH + HIDE_PART;
	                    } else {
						mFinal = num * RECENT_ITEM_WIDTH + HIDE_PART + RECENT_ITEM_WIDTH;
	                    }
	                }
	                mSplineDistance = mFinal - start;
	            }
	            //*/ tyd
