...
public abstract class SystemSetting extends ContentObserver implements Listenable {
    ...
    public SystemSetting(Context context, Handler handler, String settingName) {
        this(context, handler, settingName, 0);
    }


    public SystemSetting(Context context, Handler handler, String settingName, int defualt) {
        super(handler);
        mContext = context;
    ...
    public int getValue() {
        return System.getInt(mContext.getContentResolver(), mSettingName, defaultValue);
    }
