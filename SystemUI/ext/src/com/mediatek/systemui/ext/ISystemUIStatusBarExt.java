...
public interface ISystemUIStatusBarExt {
    ...
    /**
     * Need to show roaming icon or not.
     */
     public boolean needShowRoamingIcons(boolean isInRoaming);

    /**
     * Add clear all button to remove recent task.
     * @return true if need to add clear all button.
     */
    public boolean isClearAllButtonAllowed();
}
