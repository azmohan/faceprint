...
//*/ freeme:fanwuyang on: 2017/08/04 modify Clockview style for jingdong
...
//*/ freeme:fanwuyang on: 2017/08/04 modify Clockview style for jingdong
    private static final String ANDROID_CLOCK_JINGDONG_FONT_FILE = "/system/fonts/Clockopia.ttf";
//*/
    ...
    private Typeface getClockTypeface() {
        if (mClockTypeface == null) {
            ...
            if(SystemProperties.get("ro.freeme.xlj_jingdong").equals("1")) {
                mClockTypeface = Typeface.createFromFile(ANDROID_CLOCK_JINGDONG_FONT_FILE);
            } else {
