 ...
 */
public class VoiceUnlock implements BiometricSensorUnlock, Handler.Callback, DroiOnDismissAction {
    ...
    public VoiceUnlock(Context context, View unlockView) {
        ...
        if (unlockView != null) {
            mSecurityMessageDisplay = new KeyguardMessageArea(mContext)
                    .findSecurityMessageDisplay(unlockView);
        }
...
//        startUi();
    ...
    private void handleVoiceCommandPass(int commandId) {
        ...
        mKeyguardScreenCallback.reportUnlockAttempt(true, 0);
    ...
    private void reportFailedBiometricUnlockAttempt() {
        ...
        mKeyguardScreenCallback.reportUnlockAttempt(false, 0);
