...
public class PowerOffAlarmView extends RelativeLayout implements
    ...
    //*/add by Droi renjing 20150310 for add close snooze in poweroff alarm
            ...
            switch (msg.what) {
                ...
                case UPDATE_LABEL:
                  //add by Droi renjing 20150310 for add close snooze in poweroff alarm
                    ...
                    if(mTitleView != null){
                        editor.putString("alarm_label", msg.getData().getString("label"));             	
                        mTitleView.setText(msg.getData().getString("label"));
                    }
                  //*/add by Droi renjing 20150310 for add close snooze in poweroff alarm
                if (msg.getData().getString("isSnooze").equals("0")) {
                    editor.putBoolean("alarm_snooze", false);
                    if (mGlowPadView != null) {
                        mGlowPadView.setTargetResources(R.array.droi_dismiss_drawables_no);
                    }
    ...
    public PowerOffAlarmView(Context context, AttributeSet attrs) {
        ...
        mContext = context;
        //*/ add by Droi renjing 20150310 for add close snooze in poweroff alarm
        prefs = mContext.getSharedPreferences(Alarms.PREFERENCES, 0);
        SharedPreferences.Editor editor  = prefs.edit();
    	editor.putString("alarm_label", "");
    	editor.putBoolean("alarm_snooze", true);
    	editor.commit();
    	//*/
    }
    ...
    protected void onFinishInflate() {
        ...
        //*/ add by Droi renjing 20150310 for add close snooze in poweroff alarm
        prefs = mContext.getSharedPreferences(Alarms.PREFERENCES, 0);
        isSnooze = prefs.getBoolean("alarm_snooze", true);
        label = prefs.getString("alarm_label", "");
        //*/
    ...
    private final BroadcastReceiver mReceiver = new BroadcastReceiver() {
       ...
       public void onReceive(Context context, Intent intent) {
          ...
          if (UPDATE_LABEL_ACTION.equals(action)) {
              ...
              //*/ add by Droi renjing 20150310 for add close snooze in poweroff alarm
              data.putString("isSnooze", intent.getStringExtra("isSnooze"));
              //*/
              msg.setData(data);
    ...
    private static final String SNOOZE = "com.freeme.deskclock.SNOOZE_ALARM";
    private static final String DISMISS_AND_POWEROFF = "com.freeme.deskclock.DISMISS_ALARM";
    private static final String DISMISS_AND_POWERON = "com.freeme.deskclock.POWER_ON_ALARM";
