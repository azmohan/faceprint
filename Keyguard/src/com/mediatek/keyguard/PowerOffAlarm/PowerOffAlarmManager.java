...
public class PowerOffAlarmManager {
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                ...
                case RESHOW_KEYGUARD_LOCK:
                    ...
                    mViewMediatorCallback.hideLocked();
                    /// M: 748639, avoid to call appWidgetHost startListening
                    /// then stopListening by hide().
                    postDelayed(new Runnable() {
                        @Override
                        public void run() {
                            /// M: 687963, fix SIM PIN lock needs to show
                            /// in LockScreen disabled case.
                            if (!mLockPatternUtils.isLockScreenDisabled(
                                    KeyguardUpdateMonitor.getCurrentUser())
                                    || mViewMediatorCallback.isSecure()) {
                                mViewMediatorCallback.setSuppressPlaySoundFlag();
    ...
    private void startAlarmService() {
        ...
        in.setPackage("com.freeme.deskclock");
