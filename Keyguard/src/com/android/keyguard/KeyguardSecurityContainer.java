...
public class KeyguardSecurityContainer extends FrameLayout implements KeyguardSecurityView {
    ...
    private KeyguardSecurityCallback mCallback = new KeyguardSecurityCallback() {
        ...
        public void dismiss(boolean authenticated,Runnable run) {
            mSecurityCallback.dismiss(authenticated);
        }
        
        public void dismiss(boolean authenticated,Intent intent) {
            mSecurityCallback.dismiss(authenticated);
        }
        //*/
    ...
    //*/ Modified by freeme shijiachen 20150713 for, reform keyguard with free me 3.0
    @Override
