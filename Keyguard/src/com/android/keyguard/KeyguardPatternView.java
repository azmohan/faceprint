    ...
    private class UnlockPatternListener implements LockPatternView.OnPatternListener {
        ...
        public void onPatternDetected(final List<LockPatternView.Cell> pattern) {
            ...
            if (pattern.size() < LockPatternUtils.MIN_PATTERN_REGISTER_FAIL) {
                mLockPatternView.enableInput();
                onPatternChecked(false, 0, false /* not valid - too short */,pattern);
                return;
            }
            ...
            mPendingLockCheck = LockPatternChecker.checkPattern(
                    ...
                    new LockPatternChecker.OnCheckCallback() {
                        ...
                        public void onChecked(boolean matched, int timeoutMs) {
                            ...
                            onPatternChecked(matched, timeoutMs, true,pattern);
                        }
                    });
        ...
        private void onPatternChecked(boolean matched, int timeoutMs, boolean isValidPattern,List<LockPatternView.Cell> pattern) {
            if (matched) {
                ...
                //*/Added by freeme Greg 2014-05-26,for visitor mode
                Context context = getContext();
                String modeState = VisitorModeUtil.getVistorModelType(context);
                if (VisitorModeUtil.VISTOR_MODE_PASSWORD_STATE_PATTERN.equals(modeState)) {
                    String vistorPatternString = VisitorModeUtil.getVistorSettingsValue(context, VisitorModeUtil.VISTOR_MODE_PATTERN);
                    String inputPatternString = mLockPatternUtils.patternToString(pattern);
                    if(inputPatternString.equals(vistorPatternString)) {
