...
public class KeyguardStatusView extends GridLayout {
    ...
    protected void onFinishInflate() {
        ...
        LinearLayout clockLayout =
                (LinearLayout) findViewById(R.id.keyguard_clock_container);
        LinearLayout mtkClockLayout =
                (LinearLayout) findViewById(R.id.mtk_keyguard_clock_container);
    ...
    public void refreshTime() {
        ...
        if (bA1Support) {
            ...
            if (null != mMTKClockView) {
                mMTKClockView.updateTime();
            }
        }
    }
    ...
    public final View getClockView() {
       final  View clockView;
        if(bA1Support){
            ...
            clockView = mMTKClockView;
        }
        return clockView;
    }
    
    public TextClock getDateView() {
        return mDateView;
    }
    
    public TextView getAlarmView() {
        return mAlarmStatusView;
    }
