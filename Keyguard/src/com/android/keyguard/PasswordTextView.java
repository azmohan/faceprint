...
public class PasswordTextView extends View {
    ...
    public void append(char c) {
        ...
        if (mOnPasswordTextChangedListener != null){
            mOnPasswordTextChangedListener.onPasswordTextChanged();
        }
        //*/
    }
    ...
    //*/Added by Freeme Greg 2015-08-28,for auto unlock lockscreen
    private OnPasswordTextChangedListener mOnPasswordTextChangedListener = null;

    public void setOnPasswordTextChangedListener(OnPasswordTextChangedListener listener){
        mOnPasswordTextChangedListener = listener;
    }

    public interface OnPasswordTextChangedListener {
