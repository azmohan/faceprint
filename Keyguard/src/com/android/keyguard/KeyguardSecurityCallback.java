...
public interface KeyguardSecurityCallback {
    ...
    //*/added by shijiachen 20150813 for dismiss action after keyguard dismiss
    /**
     * Dismiss the given security screen.
     * @param securityVerified true if the user correctly entered credentials for the given screen.
     * @param the Intent to run after the lockscreen is unlocked
     */
    void dismiss(boolean securityVerified,Intent intent);
    
    /**
     * Dismiss the given security screen.
     * @param securityVerified true if the user correctly entered credentials for the given screen.
     * @param the runnable to run after the lockscreen is unlocked
     */
    void dismiss(boolean securityVerified,Runnable runOnDismiss);
    //*/
    /**
     ...
     * @param action
     */
    void setOnDismissAction(DroiOnDismissAction action);
