...
public interface KeyguardSecurityView {
    ...
    KeyguardUpdateMonitorCallback getKeyguardUpdateMonitorCallback();
    //*/
    
  //*/ Modified by shijiachen 20150727 for customize keyguard
    void notificationVisibleChange(boolean isVisible);
    
    void onWallpaperChanged(Drawable drawable);
   //*/
}
