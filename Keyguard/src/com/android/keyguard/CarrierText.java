...
public class CarrierText extends TextView {
    ...
    protected void updateCarrierText() {
        ...
        for (int phoneId = 0; phoneId < mNumOfPhone; phoneId++) {
            ...
            //*/ modify by Droi  john 2015-8-14 for not show spn start
            //CharSequence carrierName = (subInfo == null) ? null : subInfo.getCarrierName();
            CharSequence carrierName = (subInfo == null) ? null : subInfo.getDisplayName();
            //*/
            ...
            if (carrierTextForSimState != null) {
                mCarrier[phoneId] = carrierTextForSimState.toString().trim() ;
            } else {
        ...
        Log.d(TAG, "updateCarrierText()2 - after combination, carrierFinalContent = " +
                   carrierFinalContent) ;
